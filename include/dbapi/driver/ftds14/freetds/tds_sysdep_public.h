...
#    include <corelib/ncbitype.h>
  typedef  Int2   int16_t;	/* 16-bit int */
  typedef Uint2  uint16_t;	/* 16-bit int */
  typedef  Int4   int32_t;	/* 32-bit int */
  typedef Uint4  uint32_t;	/* 32-bit int */
  typedef  Int8   int64_t;	/* 64-bit int */
  typedef Uint8  uint64_t;	/* 64-bit int */
#  endif
#endif
