#ifndef CGI___CGIAPP_CACHED__HPP
#define CGI___CGIAPP_CACHED__HPP
...
class NCBI_XCGI_EXPORT CCgiApplicationCached : public CCgiApplication
{
...
#endif // CGI___CGIAPP_CACHED__HPP
