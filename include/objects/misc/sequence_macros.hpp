...
bool is_unique(Iterator iter1, Iterator iter2)
{
    Iterator prev = iter1;
    if (iter1 == iter2) {
        return true;
...
bool is_unique(Iterator iter1, Iterator iter2, Predicate pred)
{
    Iterator prev = iter1;
    if (iter1 == iter2) {
        return true;
...
(Base##_Test(Var) && \
objects::is_sorted (Base##_Set(Var).begin(), \
                    Base##_Set(Var).end(), \
                    Func()))
...
(Base##_Test(Var) && \
objects::is_unique (Base##_Set(Var).begin(), \
                    Base##_Set(Var).end(), \
                    Func()))
