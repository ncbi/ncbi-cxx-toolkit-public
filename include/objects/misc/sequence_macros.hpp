...
#define IF_SEQENTRY_HAS_DESCRIPTOR(Var) \
IF_HAS (SEQDESC_ON_SEQENTRY, Var)

/// SEQENTRY_HAS_DESCRIPTOR

#define SEQENTRY_HAS_DESCRIPTOR(Var) \
...
#define ERASE_DESCRIPTOR_ON_SEQENTRY(Itr, Var) \
...
#define IF_SEQENTRY_HAS_ANNOT(Var) \
IF_HAS (SEQANNOT_ON_SEQENTRY, Var)

/// SEQENTRY_HAS_ANNOT

#define SEQENTRY_HAS_ANNOT(Var) \
...
#define ERASE_ANNOT_ON_SEQENTRY(Itr, Var) \
...
#define IF_BIOSEQ_HAS_DESCRIPTOR(Var) \
IF_HAS (SEQDESC_ON_BIOSEQ, Var)

/// BIOSEQ_HAS_DESCRIPTOR

#define BIOSEQ_HAS_DESCRIPTOR(Var) \
...
#define ERASE_DESCRIPTOR_ON_BIOSEQ(Itr, Var) \
...
#define IF_BIOSEQ_HAS_ANNOT(Var) \
IF_HAS (SEQANNOT_ON_BIOSEQ, Var)

/// BIOSEQ_HAS_ANNOT

#define BIOSEQ_HAS_ANNOT(Var) \
...
#define ERASE_ANNOT_ON_BIOSEQ(Itr, Var) \
...
#define IF_SEQSET_HAS_DESCRIPTOR(Var) \
IF_HAS (SEQDESC_ON_SEQSET, Var)

/// SEQSET_HAS_DESCRIPTOR

#define SEQSET_HAS_DESCRIPTOR(Var) \
...
#define ERASE_DESCRIPTOR_ON_SEQSET(Itr, Var) \
...
#define IF_SEQSET_HAS_ANNOT(Var) \
IF_HAS (SEQANNOT_ON_SEQSET, Var)

/// SEQSET_HAS_ANNOT

#define SEQSET_HAS_ANNOT(Var) \
...
#define ERASE_ANNOT_ON_SEQSET(Itr, Var) \
...
#define IF_ANNOT_IS_FEATURE(Var) \
IF_HAS (SEQFEAT_ON_SEQANNOT, Var)

/// ANNOT_IS_FEATURE

#define ANNOT_IS_FEATURE(Var) \
...
#define ERASE_FEATURE_ON_ANNOT(Itr, Var) \
...
#define IF_ANNOT_IS_ALIGN(Var) \
IF_HAS (SEQALIGN_ON_SEQANNOT, Var)

/// ANNOT_IS_ALIGN

#define ANNOT_IS_ALIGN(Var) \
...
#define ERASE_ALIGN_ON_ANNOT(Itr, Var) \
...
#define IF_ANNOT_IS_GRAPH(Var) \
IF_HAS (SEQGRAPH_ON_SEQANNOT, Var)

/// ANNOT_IS_GRAPHS

#define ANNOT_IS_GRAPHS(Var) \
...
#define ERASE_GRAPH_ON_ANNOT(Itr, Var) \
...
#define IF_ANNOT_IS_SEQTABLE(Var) \
IF_HAS (SEQTABLE_ON_SEQANNOT, Var)

/// ANNOT_IS_SEQTABLE

#define ANNOT_IS_SEQTABLE(Var) \
...
#define IF_ANNOT_HAS_ANNOTDESC(Var) \
IF_HAS (ANNOTDESC_ON_SEQANNOT, Var)

/// ANNOT_HAS_ANNOTDESC

#define ANNOT_HAS_ANNOTDESC(Var) \
...
#define ERASE_ANNOTDESC_ON_ANNOT(Itr, Var) \
...
#define IF_DESCR_HAS_DESCRIPTOR(Var) \
IF_HAS (SEQDESC_ON_SEQDESCR, Var)

/// DESCR_HAS_DESCRIPTOR

#define DESCR_HAS_DESCRIPTOR(Var) \
...
#define ERASE_DESCRIPTOR_ON_DESCR(Itr, Var) \
...
#define IF_DESCRIPTOR_CHOICE_IS(Var, Chs) \
IF_CHOICE (SEQDESC_CHOICE, Var, Chs)

/// DESCRIPTOR_CHOICE_IS

#define DESCRIPTOR_CHOICE_IS(Var, Chs) \
...
#define IF_FEATURE_CHOICE_IS(Var, Chs) \
IF_CHOICE (SEQFEAT_CHOICE, Var, Chs)

/// FEATURE_CHOICE_IS

#define FEATURE_CHOICE_IS(Var, Chs) \
...
#define IF_FEATURE_HAS_GBQUAL(Var) \
IF_HAS (GBQUAL_ON_SEQFEAT, Var)

/// FEATURE_HAS_GBQUAL

#define FEATURE_HAS_GBQUAL(Var) \
...
#define ERASE_GBQUAL_ON_FEATURE(Itr, Var) \
...
#define IF_FEATURE_HAS_SEQFEATXREF(Var) \
IF_HAS (SEQFEATXREF_ON_SEQFEAT, Var)

/// FEATURE_HAS_SEQFEATXREF

#define FEATURE_HAS_SEQFEATXREF(Var) \
...
#define ERASE_SEQFEATXREF_ON_FEATURE(Itr, Var) \
...
#define IF_FEATURE_HAS_DBXREF(Var) \
IF_HAS (DBXREF_ON_SEQFEAT, Var)

/// FEATURE_HAS_DBXREF

#define FEATURE_HAS_DBXREF(Var) \
...
#define ERASE_DBXREF_ON_FEATURE(Itr, Var) \
...
#define IF_GENE_HAS_SYNONYM(Var) \
IF_HAS (SYNONYM_ON_GENEREF, Var)

/// GENE_HAS_SYNONYM

#define GENE_HAS_SYNONYM(Var) \
...
#define ERASE_SYNONYM_ON_GENE(Itr, Var) \
...
#define IF_GENE_HAS_DBXREF(Var) \
IF_HAS (DBXREF_ON_GENEREF, Var)

/// GENE_HAS_DBXREF

#define GENE_HAS_DBXREF(Var) \
...
#define ERASE_DBXREF_ON_GENE(Itr, Var) \
...
#define IF_PROT_HAS_NAME(Var) \
IF_HAS (NAME_ON_PROTREF, Var)

/// PROT_HAS_NAME

#define PROT_HAS_NAME(Var) \
...
#define ERASE_NAME_ON_PROT(Itr, Var) \
...
#define IF_PROT_HAS_ECNUMBER(Var) \
IF_HAS (ECNUMBER_ON_PROTREF, Var)

/// PROT_HAS_ECNUMBER

#define PROT_HAS_ECNUMBER(Var) \
...
#define ERASE_ECNUMBER_ON_PROT(Itr, Var) \
...
#define IF_PROT_HAS_ACTIVITY(Var) \
IF_HAS (ACTIVITY_ON_PROTREF, Var)

/// PROT_HAS_ACTIVITY

#define PROT_HAS_ACTIVITY(Var) \
...
#define ERASE_ACTIVITY_ON_PROT(Itr, Var) \
...
#define IF_PROT_HAS_DBXREF(Var) \
IF_HAS (DBXREF_ON_PROTREF, Var)

/// PROT_HAS_DBXREF

#define PROT_HAS_DBXREF(Var) \
...
#define ERASE_DBXREF_ON_PROT(Itr, Var) \
