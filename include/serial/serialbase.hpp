...
public:
    ...
    static void PreReadMember(CObjectIStream& in,
                              const CObjectInfoMI& member)
        {
            static_cast<Class*>(GetClassObjectPtr(member))
                ->PreReadMember(in, member);
        }
    static void PreReadVariant(CObjectIStream& in,
                               const CObjectInfoCV& variant)
        {
            static_cast<Class*>(GetChoiceObjectPtr(variant))
                ->PreReadVariant(in, variant);
        }
};
...
template<class CInfo>
inline
void NCBISERSetPreReadMember(const void* /*object*/, CInfo* /*info*/)
{
}

template<class CInfo>
inline
void NCBISERSetPreReadVariant(const void* /*object*/, CInfo* /*info*/)
{
}
...
#define NCBISER_HAVE_PRE_READ_MEMBER(Class, Name)                       \
    template<class CInfo>                                               \
    inline                                                              \
    void NCBISERSetPreReadMember(const Class* /*object*/, CInfo* info)  \
    {                                                                   \
        NCBI_NS_NCBI::SetPreReadMember                                  \
            (info, Name, &NCBI_NS_NCBI::CClassPrePostReadWrite<Class>::PreReadMember); \
    }

#define NCBISER_HAVE_PRE_READ_VARIANT(Class, Name)                      \
    template<class CInfo>                                               \
    inline                                                              \
    void NCBISERSetPreReadVariant(const Class* /*object*/, CInfo* info) \
    {                                                                   \
        NCBI_NS_NCBI::SetPreReadVariant                                 \
            (info, Name, &NCBI_NS_NCBI::CClassPrePostReadWrite<Class>::PreReadVariant); \
    }
