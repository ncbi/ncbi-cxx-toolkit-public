...
public:
    ...
    // default encoding of 'string' objects
    void SetDefaultStringEncoding(EEncoding enc);
    EEncoding GetDefaultStringEncoding(void) const;
    // When set, the stream omits 'scope prefixes'.
    // Using scope prefixes is the default for C++ data objects
    ...
    // Put into the output a reference to XML schema, or DTD, or none.
