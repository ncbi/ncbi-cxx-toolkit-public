...
/** @file igblastp_args.hpp
 * Main argument class for IGBLASTP application
 */

#ifndef ALGO_BLAST_BLASTINPUT___IGBLASTP_ARGS__HPP
#define ALGO_BLAST_BLASTINPUT___IGBLASTP_ARGS__HPP
...
class NCBI_BLASTINPUT_EXPORT CIgBlastpAppArgs : public CBlastAppArgs
{
public:
    /// Constructor
    CIgBlastpAppArgs();
...
#endif  /* ALGO_BLAST_BLASTINPUT___IGBLASTP_ARGS__HPP */
