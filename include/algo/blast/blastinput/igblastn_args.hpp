...
/** @file igblastn_args.hpp
 * Main argument class for IGBLASTN application
 */

#ifndef ALGO_BLAST_BLASTINPUT___IGBLASTN_ARGS__HPP
#define ALGO_BLAST_BLASTINPUT___IGBLASTN_ARGS__HPP
...
class NCBI_BLASTINPUT_EXPORT CIgBlastnAppArgs : public CBlastAppArgs
{
public:
    /// Constructor
    CIgBlastnAppArgs();
...
#endif  /* ALGO_BLAST_BLASTINPUT___IGBLASTN_ARGS__HPP */
