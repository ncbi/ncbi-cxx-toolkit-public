...
NCBI_BLASTINPUT_EXPORT extern const string kArgOutputFormat;
/// Default value for formatted output type
NCBI_BLASTINPUT_EXPORT extern const int kDfltArgOutputFormat;
/// Argument to specify whether the GIs should be shown in the deflines in the
/// traditional BLAST report
NCBI_BLASTINPUT_EXPORT extern const string kArgShowGIs;
/// Default value for the "show GIs" formatter option
NCBI_BLASTINPUT_EXPORT extern const bool kDfltArgShowGIs;
/// Argument to specify the number of one-line descriptions to show in the
/// traditional BLAST report
NCBI_BLASTINPUT_EXPORT extern const string kArgNumDescriptions;
/// Default number of one-line descriptions to display in the traditional
/// BLAST report
NCBI_BLASTINPUT_EXPORT extern const size_t kDfltArgNumDescriptions;
/// Argument to specify the number of alignments to show in the traditional 
/// BLAST report
NCBI_BLASTINPUT_EXPORT extern const string kArgNumAlignments;
/// Default number of alignments to display in the traditional BLAST report
NCBI_BLASTINPUT_EXPORT extern const size_t kDfltArgNumAlignments;
/// Argument to specify whether to create output as HTML or not
NCBI_BLASTINPUT_EXPORT extern const string kArgProduceHtml;
/// Default value which specifies whether to create output as HTML or not
NCBI_BLASTINPUT_EXPORT extern const bool kDfltArgProduceHtml;
...
NCBI_BLASTINPUT_EXPORT extern const string kDfltArgTabularOutputFmt;
/// Tag/keyword which is equivalent to using kDfltArgTabularOutputFmt
NCBI_BLASTINPUT_EXPORT extern const string kDfltArgTabularOutputFmtTag;
...
NCBI_BLASTINPUT_EXPORT extern const SFormatSpec sc_FormatSpecifiers[];
/// Number of elements in the sc_FormatSpecifiers array.
NCBI_BLASTINPUT_EXPORT extern const size_t kNumTabularOutputFormatSpecifiers;

/// Returns a string documenting the available format specifiers
NCBI_BLASTINPUT_EXPORT string DescribeTabularOutputFormatSpecifiers();
