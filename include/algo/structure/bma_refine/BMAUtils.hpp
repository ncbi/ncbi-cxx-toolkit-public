...
*
* Revision 1.8  2005/03/08 21:30:19  lanczyck
* add MapAlignmentIndexToSeqIndex method
*
* Revision 1.7  2004/12/03 23:14:16  lanczyck
* allow PrintPSSM to write to a string
*
* Revision 1.6  2004/12/03 02:05:12  lanczyck
...
*
* Revision 1.5  2004/11/29 23:35:30  lanczyck
* overhaul the pssm printing routines
*
* Revision 1.4  2004/11/18 16:06:58  lanczyck
* add a print-by-column option to print pssm
*
* Revision 1.3  2004/11/18 15:21:40  lanczyck
* add some options for printing pssm
*
* Revision 1.2  2004/11/09 22:35:53  lanczyck
* make BMAUtils a class of static methods; fix bug w/ getting scores from pssm
*
* Revision 1.1  2004/11/05 22:18:42  lanczyck
* global functions, struct for align_refine namespace
*
* ---------------------------------------------------------------------------
*/
