#ifndef UTIL_COMPRESS__ZLIB_CLOUDFLARE__HPP
#define UTIL_COMPRESS__ZLIB_CLOUDFLARE__HPP
...
/// @file zlib_cloudflare.hpp
///
/// ZLib Compression API - Cloudflare ZLIB wrapper (https://github.com/cloudflare/zlib)
///
/// CZipCloudflareCompression        - base methods for compression/decompression
///                                    memory buffers and files.
/// CZipCloudflareCompressionFile    - allow read/write operations on files in
///                                    zlib or gzip (.gz) format.
/// CZipCloudflareCompressor         - zlib based compressor
///                                    (used in CZipCloudflareStreamCompressor). 
...
#include <util/compress/zlib.hpp> // for kZlibDefault* constants
...
class NCBI_XUTIL_EXPORT CZipCloudflareCompression : public CCompression
{
public:
    ...
    typedef CZipCloudflareCompression::TFlags TZipFlags; ///< Bitwise OR of EFlags
...
private:
    ...
    CZipCloudflareCompression& operator= (const CZipCloudflareCompression&);
};
...
class NCBI_XUTIL_EXPORT CZipCloudflareCompressionFile : public CZipCloudflareCompression,
...
private:
    ...
    /// Private assignment operator to prohibit assignment.
    CZipCloudflareCompressionFile& operator= (const CZipCloudflareCompressionFile&);
};
...
///
/// Used in CZipCloudflareStreamCompressor.
/// @sa CZipCloudflareStreamCompressor, CZipCloudflareCompression, CCompressionProcessor

class NCBI_XUTIL_EXPORT CZipCloudflareCompressor : public CZipCloudflareCompression,
...
///
/// Used in CZipCloudflareStreamDecompressor.
/// @sa CZipCloudflareStreamDecompressor, CZipCloudflareCompression, CCompressionProcessor

class NCBI_XUTIL_EXPORT CZipCloudflareDecompressor : public CZipCloudflareCompression,
                                                     public CCompressionProcessor
{
public:
    /// Constructor.
...
/// @note
///   Compression/decompression flags (CZipCloudflareCompression:EFlags) can greatly
///   affect CZipCloudflareStreamCompressor behavior. By default, compressor
...
class NCBI_XUTIL_EXPORT CZipCloudflareStreamCompressor
...
public:
    ...
    CZipCloudflareStreamCompressor(
        ...
        : CCompressionStreamProcessor(
              new CZipCloudflareCompressor(level, flags),
    ...
    CZipCloudflareCompressor* GetCompressor(void) const {
        return dynamic_cast<CZipCloudflareCompressor*>(GetProcessor());
    }
};
...
/// @note
///   Compression/decompression flags (CZipCloudflareCompression:EFlags) can greatly
///   affect CZipCloudflareStreamDecompressor behavior. By default, decompressor
///   do not allow data in gzip format. Please use appropriate flags
///   in constructor to change default behavior.
/// @sa CCompressionStreamProcessor

class NCBI_XUTIL_EXPORT CZipCloudflareStreamDecompressor
    : public CCompressionStreamProcessor
{
public:
    /// Full constructor
    CZipCloudflareStreamDecompressor(
        streamsize                 in_bufsize,
        streamsize                 out_bufsize,
        CZipCloudflareCompression::TZipFlags flags = 0
        )
    ...
    CZipCloudflareDecompressor* GetDecompressor(void) const {
        return dynamic_cast<CZipCloudflareDecompressor*>(GetProcessor());
    }
};
...
#endif  /* UTIL_COMPRESS__ZLIB_CLOUDFLARE__HPP */
