...
#  define NCBI_CREADERS_EXPORTS
#endif


#ifdef NCBI_CREADERS_EXPORTS
#  define NCBI_CREADERS_EXPORT      __declspec(dllexport)
#else
#  define NCBI_CREADERS_EXPORT      __declspec(dllimport)
#endif
