...
namespace compile_time_bits
{
    ...
    constexpr
        typename std::enable_if<std::is_constructible<ct_string, const _T&>::value, bool>::type
        operator==(const ct_string& l, const _T& r) noexcept
    {
    ...
    constexpr
        typename std::enable_if<std::is_constructible<ct_string, const _T&>::value, bool>::type
        operator==(const _T& l, const ct_string& r) noexcept
    {
