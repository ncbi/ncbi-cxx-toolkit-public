...
public:
    enum EErrCode {
        eGetTerminalAttrError,  ///< UNIX specific: cannot get term attributes
        eSetTerminalAttrError,  ///< UNIX specific: cannot set term attributes
        eGetLineError,          ///< UNIX specific: error reading from terminal
