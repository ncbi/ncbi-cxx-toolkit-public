...
enum EBestFeatOpts {
    ...
    /// when comparing locations, if either location is mixed or in a bad
    /// order, sort the location and ignore strands when comparing,
    /// and convert subset matching to extremes matching.
