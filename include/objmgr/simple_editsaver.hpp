#ifndef __SIMPLE_EDIT_SAVER__HPP
#define __SIMPLE_EDIT_SAVER__HPP
...
class NCBI_XOBJMGR_EXPORT CSimpleEditSaver : public CUnsupportedEditSaver
{
public:
    ...
    virtual void ResetIds(const CBioseq_Handle&, ECallMode);
    ...
    virtual void Reset(const CSeq_entry_Handle& entry, ECallMode);
    ...
    virtual void Remove(const CBioseq_set_Handle& handle, 
                        const CSeq_entry_Handle&, ECallMode);
    ...
    virtual void Remove(const CSeq_feat_Handle& handle, ECallMode);
    virtual void Remove(const CSeq_align_Handle& handle, ECallMode);
    virtual void Remove(const CSeq_graph_Handle& handle, ECallMode);

    //-----------------------------------------------------------------
    // virtual void RemoveTSE(const CTSE_Handle& handle, ECallMode);

    virtual void UpdateSeq(const CBioseq_Handle& handle, ECallMode mode) = 0;
    virtual void UpdateTSE(const CSeq_entry_Handle& handle, ECallMode mode) = 0;
    virtual void UpdateSet(const CBioseq_set_Handle& handle, ECallMode mode);

protected:    
    void UpdateEntry(const CSeq_entry_Handle& handle, ECallMode mode);
};
...
#endif // __SIMPLE_EDIT_SAVER__HPP
