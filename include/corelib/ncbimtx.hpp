...
/////////////////////////////////////////////////////////////////////////////
// CExceptMutex - exceptions generated by mutexes


class CExceptMutex : public CExceptCorelib
{
public:
    enum EErrCode {
        eLock,
    ...
    NCBI_EXCEPTION_DEFAULT(CExceptMutex,CExceptCorelib);
};
...
#  endif
    NCBI_THROW(CExceptMutex,eLock, "Mutex lock failed");
#endif
}
...
#  endif
    NCBI_THROW(CExceptMutex,eUnlock, "Mutex unlock failed");
#endif
}
...
bool CInternalMutex::TryLock(void)
{
    ...
    NCBI_THROW(CExceptMutex,eTryLock,"Mutex check (TryLock) failed");
#elif defined(NCBI_POSIX_THREADS)
