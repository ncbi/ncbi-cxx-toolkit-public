...
/////////////////////////////////////////////////////////////////////////////
// CExceptApp - exceptions generated by CNcbiApplication


class CExceptApp : public CExceptCorelib
{
public:
    enum EErrCode {
        eUnsetArgs,
    ...
    NCBI_EXCEPTION_DEFAULT(CExceptApp,CExceptCorelib);
};
...
inline const CArgs& CNcbiApplication::GetArgs(void) const {
    if ( !m_Args.get() ) {
        NCBI_THROW(CExceptApp,eUnsetArgs,
