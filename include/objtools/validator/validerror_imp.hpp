...
public:
    ...
    void ValidateBioSourceForSeq(const CBioSource& bsrc, const CSerialObject& obj, const CSeq_entry *ctx, const CBioseq_Handle& bsh, const bool is_complete = false, const bool is_circular = false);
