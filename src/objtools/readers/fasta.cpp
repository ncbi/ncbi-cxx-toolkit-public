...
{
    CLinkage_evidence::TLinkage_evidence list_evidence;
...
void CFastaReader::ConvertNs2Gaps(CBioseq::TInst& inst, size_t gap_min)
{
...
void CFastaReader::HandleGaps(CBioseq& bioseq, 
    ...
    CLinkage_evidence::EType evidence)
{
    ...
    case CSeq_entry::e_Seq:
        {
            HandleGaps(entry.SetSeq(), gapNmin, gap_Unknown_length, evidence);
        }
        break;
    case CSeq_entry::e_Set:
        NON_CONST_ITERATE(CSeq_entry::TSet::TSeq_set, it, entry.SetSet().SetSeq_set())
        {
            HandleGaps(**it, gapNmin, gap_Unknown_length, evidence);
        }
        break;
    default:
        break;
