...
(2) Provide a BED input file for the test, name it dummy.bed, and put it in this
    directory.
(3) Provide an asn file that reflects the expected conversion of dummy.bed. Name 
