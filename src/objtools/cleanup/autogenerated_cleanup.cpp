...
{ // type UniSequence
  NON_CONST_ITERATE( typename Tcontainer_std_string_, iter, arg0 ) { 
    x_BasicCleanupSeqFeat_xref_E_E_data_data_txinit_txinit_gene_E_E_locus_tag_ETC( *iter );
  }
...
{ // type Sequence
  if( arg0.IsSetComment() ) {
    x_BasicCleanupSeqFeat_xref_E_E_data_data_txinit_txinit_gene_E_E_locus_ETC( arg0.SetComment() );
  }
  if( arg0.IsSetFig() ) {
