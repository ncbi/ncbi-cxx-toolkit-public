...
void CAutogeneratedCleanup::x_BasicCleanupBioseqDescr(CBioseq& bioseq)
{
    ...
    for (auto pDesc : bioseq.SetDescr().Set()) {
        x_BasicCleanupBioseqDesc(*pDesc);
    }
}
...
void CAutogeneratedCleanup::BasicCleanupBioseq(CBioseq& bioseq)
{
    ...
    m_NewCleanup.ProtSeqBC(bioseq);
    m_NewCleanup.RemoveSingleStrand(bioseq);

    if (bioseq.IsSetAnnot()) {
        x_BasicCleanupSeqAnnots(bioseq.SetAnnot());
    }

    x_BasicCleanupBioseqDescr(bioseq);
    ...
    m_NewCleanup.x_ClearEmptyDescr(bioseq);
