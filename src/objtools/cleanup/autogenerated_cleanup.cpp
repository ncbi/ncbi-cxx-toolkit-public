...
bool CAutogeneratedCleanup::x_BasicCleanupDate(CDate& date)
{
    if (date.IsStd()) {
        return m_NewCleanup.DateStdBC(date.SetStd());
    }
    return false;
}


bool CAutogeneratedCleanup::x_BasicCleanupSeqId(CSeq_id& seq_id)
{
    return m_NewCleanup.SeqIdBC(seq_id);
}
...
{ // type Choice
    ...
    m_NewCleanup.BothStrandBC(arg0);
    switch (arg0.Which()) {
...
bool CAutogeneratedCleanup::x_BasicCleanupSeqIds(TSeqIdContainer& ids)
{
    bool madeChange{ false };
    for (auto pId : ids) {
        if (x_BasicCleanupSeqId(*pId)) {
            madeChange = true;
        }
    }
    return madeChange;
...
{ // type Choice
    ...
    if (arg0.IsStd()) {
        ...
        m_NewCleanup.CompressStringSpacesMarkChanged(affil_str);
        m_NewCleanup.CleanupStringMarkChanged(affil_str);
    }
...
{ // type Sequence
    ...
    if (fix_initials) {
        m_NewCleanup.AuthListBCWithFixInitials(arg0);
    }
    if (arg0.IsSetAffil()) {
        x_BasicCleanupAffil(arg0.SetAffil());
    }
    ...
    if (arg0.IsSet()) {
        for (auto pElement : arg0.Set()) {
            if (pElement && pElement->IsName()) {
                m_NewCleanup.StripSpacesMarkChanged(pElement->SetName());
            }
        }
    }
...
void CAutogeneratedCleanup::x_BasicCleanupSeqfeatCit(CPub_set& arg0)
{ // type Choice
    switch (arg0.Which()) {
    ...
    case CPub_set::e_Pub: {
        ...
        for (auto pPub : arg0.SetPub()) {
            ...
            m_NewCleanup.RememberSeqFeatCitPubs(*pPub);
        }
    } break;
    default:
        break;
...
{ // type Primitive
    m_NewCleanup.DecodeXMLMarkChanged(arg0);
    m_NewCleanup.ConvertDoubleQuotesMarkChanged(arg0);
    m_NewCleanup.FixUpEllipsis(arg0);
...
void CAutogeneratedCleanup::x_BasicCleanupOrgMods(list<CRef<COrgMod>>& orgMods)
{
    for (auto& pOrgMod : orgMods) {
        auto& orgMod = *pOrgMod;
        CLEAN_AND_COMPRESS_STRING_MEMBER(orgMod, Attrib);
        CLEAN_AND_COMPRESS_STRING_MEMBER_JUNK(orgMod, Subname);
        m_NewCleanup.OrgModBC(orgMod);
    }
} // end of x_BasicCleanupOrgMods
...
{ // type UniSequence
    ...
    {
        x_BasicCleanupHybridOrgName(**iter);
    }
...
void CAutogeneratedCleanup::x_BasicCleanupHybridOrgName(COrgName& arg0)
{ // type Sequence
    CLEAN_STRING_MEMBER(arg0, Attrib);
    CLEAN_STRING_MEMBER(arg0, Div);
    CLEAN_STRING_MEMBER(arg0, Lineage);
    if (arg0.IsSetMod()) {
        x_BasicCleanupOrgMods(arg0.SetMod());
    }
    if (arg0.IsSetName()) {
        x_BasicCleanupOrgNameName(arg0.SetName());
    }
} // end of x_BasicCleanupHybridOrgName


void CAutogeneratedCleanup::x_BasicCleanupOrgName(COrgName& arg0, CBioSource* pBiosrc)
{ // type Sequence
    CLEAN_STRING_MEMBER(arg0, Attrib);
    CLEAN_STRING_MEMBER(arg0, Div);
    CLEAN_STRING_MEMBER(arg0, Lineage);
    ...
    if (pBiosrc) {
        m_NewCleanup.CleanupOrgModAndSubSourceOther(arg0, *pBiosrc);
    }
...
} // end of x_BasicCleanupOrgName_orgname1746


void CAutogeneratedCleanup::x_BasicCleanupCodeBreak(CCode_break& arg0)
{ // type Sequence
    if (arg0.IsSetLoc()) {
...
void CAutogeneratedCleanup::x_BasicCleanupCdregion(CCdregion& arg0)
{
    m_NewCleanup.CdregionFeatBC(arg0, *m_pCurrentSeqFeat);
    if (arg0.IsSetCode_break()) {
        for (auto pCodeBreak : arg0.SetCode_break()) {
            x_BasicCleanupCodeBreak(*pCodeBreak);
        }
    }
}
...
{ // type Primitive
    m_NewCleanup.CompressStringSpacesMarkChanged(arg0);
    m_NewCleanup.ConvertDoubleQuotesMarkChanged(arg0);
...
{ // type Primitive
    m_NewCleanup.DecodeXMLMarkChanged(arg0);
    m_NewCleanup.ConvertDoubleQuotesMarkChanged(arg0);
    m_NewCleanup.TrimInternalSemicolonsMarkChanged(arg0);
...
{ // type Sequence
    ...
    if (arg0.IsSetAllele()) {
        m_NewCleanup.ConvertDoubleQuotesMarkChanged(arg0.SetAllele());
    }
    if (arg0.IsSetDesc()) {
    ...
    if (arg0.IsSetLocus_tag()) {
        m_NewCleanup.ConvertDoubleQuotesMarkChanged(arg0.SetLocus_tag());
    }
    if (arg0.IsSetMaploc()) {
        m_NewCleanup.ConvertDoubleQuotesMarkChanged(arg0.SetMaploc());
    }
    if (arg0.IsSetSyn()) {
...
void CAutogeneratedCleanup::x_BasicCleanupOrgRef(
    COrg_ref&   arg0,
    CBioSource* pBiosrc)
{ // type Sequence
    ...
    if (m_pCurrentSeqFeat) {
        m_NewCleanup.GBQualToOrgRef(arg0, *m_pCurrentSeqFeat);
    }
    if (arg0.IsSetCommon()) {
        m_NewCleanup.TrimInternalSemicolonsMarkChanged(arg0.SetCommon());
    }
    if (arg0.IsSetDb()) {
    ...
    if (arg0.IsSetOrgname()) {
        x_BasicCleanupOrgName(arg0.SetOrgname(), pBiosrc);
    }
    CLEAN_STRING_LIST(arg0, Syn);
    m_NewCleanup.PostOrgRef(arg0);
...
{ // type UniSequence
    m_NewCleanup.CleanupECNumberList(arg0);
...
{ // type Primitive
    ...
    m_NewCleanup.CompressStringSpacesMarkChanged(arg0);
    m_NewCleanup.ConvertDoubleQuotesMarkChanged(arg0);
    m_NewCleanup.RemoveFlankingQuotes(arg0);
...
{ // type Choice
    m_NewCleanup.RememberPubOldLabel(arg0);
    switch (arg0.Which()) {
    case CPub::e_Article:
    ...
    case CPub::e_Muid:
        if (m_pCurrentSeqFeat && isSeqFeatCitPub) {
            m_NewCleanup.RememberMuidThatMightBeConvertibleToPmid(arg0);
        }
        break;
    case CPub::e_Patent:
...
static void s_GetPubsFromEquiv(const CPub_equiv& equiv, list<CRef<CPub>>& pubs)
{
    ...
    for (auto pPub : equiv.Get()) {
        ...
        if (! pPub->IsEquiv()) {
            ...
            s_GetPubsFromEquiv(pPub->GetEquiv(), pubs);
        }
    }
}
...
static void s_GetLabels(const list<CRef<CPub>>& pubs, vector<string>& labels)
{
    ...
    for (auto pPub : pubs) {
        string label;
        pPub->GetLabel(&label, CPub::eContent, CPub::fLabel_Unique);
        labels[index++] = label;
    }
}


void CAutogeneratedCleanup::x_BasicCleanupSeqfeatPub(CPubdesc& arg0, bool is_xref)
{
    list<CRef<CPub>> pubs;
    if (arg0.IsSetPub()) {
        s_GetPubsFromEquiv(arg0.GetPub(), pubs);
    }

    vector<string> old_labels(pubs.size());
    s_GetLabels(pubs, old_labels);

    if (arg0.IsSetComment()) {
        m_NewCleanup.ConvertDoubleQuotesMarkChanged(arg0.SetComment());
    }
    if (arg0.IsSetNum()) {
    ...
    if (arg0.IsSetPub()) {
        ...
        if (! is_xref) {
            m_NewCleanup.NotePubdescOrAnnotPubs(arg0.SetPub());
        }
    }
    ...
    if (! pubs.empty()) {
        ...
        s_GetLabels(pubs, new_labels);
        m_NewCleanup.LabelMapAppend(old_labels, new_labels);
    }
}
...
{ // type Primitive
    m_NewCleanup.CompressStringSpacesMarkChanged(arg0);
    m_NewCleanup.CleanupStringMarkChanged(arg0);
    m_NewCleanup.ConvertDoubleQuotesMarkChanged(arg0);
    m_NewCleanup.TrimInternalSemicolonsMarkChanged(arg0);
...
{ // type Sequence
    ...
    if (arg0.IsSetQual()) {
        m_NewCleanup.ConvertDoubleQuotesMarkChanged(arg0.SetQual());
    }
    if (arg0.IsSetVal()) {
        m_NewCleanup.ConvertDoubleQuotesMarkChanged(arg0.SetVal());
    }
...
{ // type Sequence
    ...
    if (arg0.IsSetClass()) {
        m_NewCleanup.ConvertDoubleQuotesMarkChanged(arg0.SetClass());
    }
...
void CAutogeneratedCleanup::x_BasicCleanupTxinit(CTxinit& arg0)
{ // type Sequence
    if (arg0.IsSetGene()) {
    ...
    if (arg0.IsSetTxorg()) {
        x_BasicCleanupOrgRef(arg0.SetTxorg(), nullptr);
    }
} // end of x_BasicCleanupTxinit
...
{ // type Choice
    ...
    case Tcvariation_ref_container_ncbi_cref_c_e_consequence_c_e_consequence::e_Variation:
        x_BasicCleanupVariationRef(arg0.SetVariation());
        break;
    default:
        break;
    }
...
{ // type Sequence
    if (arg0.IsSetSource()) {
        m_NewCleanup.SubSourceBC(arg0.SetSource());
    }
...
void CAutogeneratedCleanup::x_BasicCleanupVariationRef(CVariation_ref& arg0)
{ // type Sequence
...
{ // type Sequence
    if (arg0.IsSetVariations()) {
        for (auto pVariation : arg0.SetVariations()) {
            x_BasicCleanupVariationRef(*pVariation);
        }
    }
...
{ // type Choice
    ...
    case CSeqFeatData::e_Biosrc:
        x_BasicCleanupBiosource(arg0.SetBiosrc());
        break;
    case CSeqFeatData::e_Cdregion:
        x_BasicCleanupCdregion(arg0.SetCdregion());
        break;
    ...
    case CSeqFeatData::e_Org: {
        x_BasicCleanupOrgRef(arg0.SetOrg(), nullptr);
    } break;
    case CSeqFeatData::e_Prot:
        x_BasicCleanupProtRef(arg0.SetProt(), true);
        break;
    case CSeqFeatData::e_Pub:
        x_BasicCleanupSeqfeatPub(arg0.SetPub());
        break;
    ...
    case CSeqFeatData::e_Site:
        m_NewCleanup.SiteFeatBC(arg0.SetSite(), *m_pCurrentSeqFeat);
        break;
    case CSeqFeatData::e_Txinit:
        x_BasicCleanupTxinit(arg0.SetTxinit());
        break;
    case CSeqFeatData::e_User:
        m_NewCleanup.UserObjectBC(arg0.SetUser());
        break;
...
{ // type UniSequence
    m_NewCleanup.ExpandCombinedQuals(arg0);
...
void CAutogeneratedCleanup::x_BasicCleanupBiosource(CBioSource& biosrc)
{

    m_NewCleanup.BiosourceBC(biosrc);

    if (biosrc.IsSetOrg()) {
        x_BasicCleanupOrgRef(biosrc.SetOrg(), &biosrc);
    }

    if (biosrc.IsSetPcr_primers()) {
        m_NewCleanup.PCRReactionSetBC(biosrc.SetPcr_primers());
    }

    if (biosrc.IsSetSubtype()) {
        for (auto pSubSource : biosrc.SetSubtype()) {
            m_NewCleanup.SubSourceBC(*pSubSource);
        }
    }

    if (m_pCurrentSeqFeat) {
        m_NewCleanup.BiosourceFeatBC(biosrc, *m_pCurrentSeqFeat);
    }

    m_NewCleanup.PostBiosource(biosrc);
    m_NewCleanup.ModernizePCRPrimers(biosrc);
}
...
{ // type Choice
    ...
    case CSeqFeatData::e_Prot:
        ...
        break;
    case CSeqFeatData::e_Pub:
        x_BasicCleanupSeqfeatPub(arg0.SetPub(), true); // true => is Xref
        break;
    case CSeqFeatData::e_Rna:
...
void CAutogeneratedCleanup::BasicCleanupSeqFeat(const CSeq_feat_Handle& fh)
{ 
    ...
    if (arg0.IsSetCit()) {
        x_BasicCleanupSeqfeatCit(arg0.SetCit());
    }
    if (arg0.IsSetComment()) {
    ...
    if (arg0.IsSetExt()) {
        m_NewCleanup.UserObjectBC(arg0.SetExt());
    }
    if (arg0.IsSetLocation()) {
    ...
    if (arg0.IsSetTitle()) {
        m_NewCleanup.DecodeXMLMarkChanged(arg0.SetTitle());
    }
    if (arg0.IsSetXref()) {
        for (auto pXref : arg0.SetXref()) {
            x_BasicCleanupSeqFeatXref(*pXref);
        }
    }
    m_NewCleanup.PostSeqFeat(arg0);
...
void CAutogeneratedCleanup::x_BasicCleanupSeqFeats(list<CRef<CSeq_feat>>& feats)
{
...
{ // type Sequence
    if (arg0.IsSetData()) {
        x_BasicCleanupSeqTableMultiData(arg0.SetData());
    }
...
void CAutogeneratedCleanup::x_BasicCleanupSeqTableMultiData(CSeqTable_multi_data& arg0)
{ // type Choice
    switch (arg0.Which()) {
    ...
    case CSeqTable_multi_data::e_Int_delta:
        x_BasicCleanupSeqTableMultiData(arg0.SetInt_delta());
        break;
...
} // end of x_BasicCleanupSeqTableMultiData
...
void CAutogeneratedCleanup::x_BasicCleanupAnnotDesc(CAnnotdesc& arg0)
{ // type Choice
    switch (arg0.Which()) {
...
void CAutogeneratedCleanup::x_BasicCleanupAnnotDescr(CAnnot_descr& arg0)
{ // type Reference
    if (arg0.IsSet()) {
        for (auto pAnnotdesc : arg0.Set()) {
            x_BasicCleanupAnnotDesc(*pAnnotdesc);
        }
    }
} // end of x_BasicCleanupAnnotDescr


void CAutogeneratedCleanup::x_FallBackSeqAnnotMethod(const CSeq_annot_Handle& annotHandle)
{
    auto* pAnnot = const_cast<CSeq_annot*>(annotHandle.GetCompleteSeq_annot().GetPointer());
    BasicCleanupSeqAnnot(*pAnnot);
    annotHandle.GetEditHandle().Update();
}


void CAutogeneratedCleanup::BasicCleanupSeqAnnotHandle(const CSeq_annot_Handle& annotHandle)
{
    ...
    if (annotHandle.IsFtable()) {
        for (CFeat_CI feat_it(annotHandle); feat_it; ++feat_it) {
            BasicCleanupSeqFeat(*feat_it);
        }
    } else if (annotHandle.IsGraph()) {
        for (CGraph_CI graph_it(annotHandle); graph_it; ++graph_it) {
            auto new_graph = Ref(new CSeq_graph());
            new_graph->Assign(graph_it->GetOriginalGraph());
            x_BasicCleanupSeqGraph(*new_graph);
            graph_it->GetSeq_graph_Handle().Replace(*new_graph);
        }
    } else if (annotHandle.IsAlign()) {
        for (CAlign_CI align_it(annotHandle); align_it; ++align_it) {
            auto new_align = Ref(new CSeq_align());
            new_align->Assign(align_it.GetOriginalSeq_align());
            x_BasicCleanupSeqAlign(*new_align);
...
void CAutogeneratedCleanup::BasicCleanupSeqAnnot(CSeq_annot& arg0)
{
    ...
    if (arg0.IsSetDesc()) {
        x_BasicCleanupAnnotDescr(arg0.SetDesc());
    }
}
...
{ 
    m_NewCleanup.DecodeXMLMarkChanged(arg0);
    m_NewCleanup.CleanupStringJunkMarkChanged(arg0);
    m_NewCleanup.RemoveSpacesBetweenTildesMarkChanged(arg0);
} 
...
void CAutogeneratedCleanup::x_BasicCleanupBioseqDesc(CSeqdesc& arg0)
{
    // type Choice
    switch (arg0.Which()) {
    ...
    case CSeqdesc::e_Molinfo: {
        ...
        if (arg0.GetMolinfo().IsSetBiomol()) {
            mBiomol = arg0.GetMolinfo().GetBiomol();
        }
    } break;
    case CSeqdesc::e_Name:
        m_NewCleanup.CleanupStringMarkChanged(arg0.SetName());
        break;
    case CSeqdesc::e_Num:
        x_BasicCleanupNumbering(arg0.SetNum());
        break;
    ...
    case CSeqdesc::e_Source:
        x_BasicCleanupBiosource(arg0.SetSource());
        break;
    case CSeqdesc::e_Sp:
    ...
    return;
} // end of x_BasicCleanupBioseqDesc


void CAutogeneratedCleanup::x_BasicCleanupBioseqDescr(const CBioseq_Handle& bsh)
{
    if (! bsh.IsSetDescr() || ! bsh.GetDescr().IsSet()) {
        return;
    }
    ...
    for (auto pDesc : bsh.GetDescr().Get()) {
        ...
        x_BasicCleanupBioseqDesc(*pNewDesc);
        bsh.GetEditHandle().ReplaceSeqdesc(*pDesc, *pNewDesc);
    }
}


void CAutogeneratedCleanup::x_BasicCleanupDeltaExt(CDelta_ext& arg0, CSeq_inst::ERepr repr)
{ // type Reference
    if (repr == CSeq_inst::eRepr_delta) {
        m_NewCleanup.RemoveZeroLengthLiterals(arg0);
    }
    if (arg0.IsSet()) {
...
void CAutogeneratedCleanup::x_BasicCleanupMapExt(CMap_ext& arg0)
{ // type Reference
    if (arg0.IsSet()) {
        x_BasicCleanupSeqFeats(arg0.Set());
    }
} // end of x_BasicCleanupMapExt


void CAutogeneratedCleanup::x_BasicCleanupSegExt(CSeg_ext& arg0)
{ // type Reference
    if (arg0.IsSet()) {
        x_BasicCleanupSeqLocs(arg0.Set());
    }
} // end of x_BasicCleanupSegExt

void CAutogeneratedCleanup::x_BasicCleanupSeqExt(CSeq_ext& arg0, CSeq_inst::ERepr repr)
{ // type Choice
    switch (arg0.Which()) {
    case CSeq_ext::e_Delta:
        x_BasicCleanupDeltaExt(arg0.SetDelta(), repr);
        break;
    case CSeq_ext::e_Map:
        x_BasicCleanupMapExt(arg0.SetMap());
        break;
    case CSeq_ext::e_Ref:
        x_BasicCleanupSeqLoc(arg0.SetRef());
        break;
    case CSeq_ext::e_Seg:
        x_BasicCleanupSegExt(arg0.SetSeg());
        break;
    default:
        break;
    }
...
void CAutogeneratedCleanup::x_BasicCleanupBioseq_inst(const CBioseq_Handle& bsh)
{
    if (mBiomol.has_value()) {
        m_NewCleanup.FixUnsetMolFromBiomol(*mBiomol, bsh);
    }

    if (bsh.IsSetInst_Ext()) {
        const auto repr = bsh.IsSetInst_Repr() ? bsh.GetInst_Repr() : CSeq_inst::eRepr_not_set;

        auto pExt = Ref(new CSeq_ext());
        pExt->Assign(bsh.GetInst_Ext());

        x_BasicCleanupSeqExt(*pExt, repr);
        bsh.GetEditHandle().SetInst_Ext(*pExt);
    }

    if (bsh.IsSetInst_Hist()) {
        auto pHist = Ref(new CSeq_hist());
        pHist->Assign(bsh.GetInst_Hist());

        x_BasicCleanupSeqHist(*pHist);
        bsh.GetEditHandle().SetInst_Hist(*pHist);
    }
}


void CAutogeneratedCleanup::BasicCleanupBioseqHandle(const CBioseq_Handle& bsh)
{
    mBiomol.reset();

    m_NewCleanup.ProtSeqBC(bsh);
    m_NewCleanup.RemoveSingleStrand(bsh);

    if (bsh.HasAnnots()) {
        x_BasicCleanupSeqAnnots(bsh);
    }

    x_BasicCleanupBioseqDescr(bsh);

    if (bsh.IsSetId()) {
        m_NewCleanup.BasicCleanupSeqIds(bsh);
    }

    if (bsh.IsSetInst()) {
        x_BasicCleanupBioseq_inst(bsh);
    }

    m_NewCleanup.AddPartialToProteinTitle(bsh);

    m_NewCleanup.ClearEmptyDescr(bsh);
} 


void CAutogeneratedCleanup::x_BasicCleanupSeqAnnots(list<CRef<CSeq_annot>>& annots)
{ // type UniSequence
...
void CAutogeneratedCleanup::x_BasicCleanupSeqAnnots(const CBioseq_Handle& bsh)
{
    CSeq_annot_CI annot_it(bsh.GetParentEntry(), CSeq_annot_CI::eSearch_entry);
    for (; annot_it; ++annot_it) {
        BasicCleanupSeqAnnotHandle(*annot_it);
    }
}

void CAutogeneratedCleanup::x_BasicCleanupSeqAnnots(const CBioseq_set_Handle& bssh)
{
    CSeq_annot_CI annot_it(bssh, CSeq_annot_CI::eSearch_entry);
    for (; annot_it; ++annot_it) {
        BasicCleanupSeqAnnotHandle(*annot_it);
    }
}
...
} // end of x_BasicCleanupBioseqSetDesc



void CAutogeneratedCleanup::x_BasicCleanupBioseqSetDescr(const CBioseq_set_Handle& bssh)
{
    if (! bssh.IsSetDescr() || ! bssh.GetDescr().IsSet()) {
        return;
    }

    for (auto pDesc : bssh.GetDescr().Get()) {
        auto pNewDesc = Ref(new CSeqdesc());
        pNewDesc->Assign(*pDesc);
        x_BasicCleanupBioseqSetDesc(*pNewDesc);
        bssh.GetEditHandle().ReplaceSeqdesc(*pDesc, *pNewDesc);
    }
}
...
{ 
    ...
    auto seh = m_Scope.GetSeq_entryHandle(arg0);
    BasicCleanupSeqEntryHandle(seh);
} 


void CAutogeneratedCleanup::BasicCleanupSeqEntryHandle(const CSeq_entry_Handle& entry_handle)
{ 
    m_NewCleanup.CopyGBBlockDivToOrgnameDiv(entry_handle);
    switch (entry_handle.Which()) {
    case CSeq_entry::e_Seq:
        BasicCleanupBioseqHandle(entry_handle.GetSeq());
        break;
    case CSeq_entry::e_Set: 
        BasicCleanupBioseqSetHandle(entry_handle.GetSet());
        break;
    default:
        break;
    }
...
{ // type Choice
    ...
    case CSeq_submit::C_Data::e_Annots:
        x_BasicCleanupSeqAnnots(arg0.SetAnnots());
        break;
...
void CAutogeneratedCleanup::BasicCleanupBioseqSetHandle(const CBioseq_set_Handle& bssh)
{
    m_NewCleanup.SetClass(bssh);

    if (bssh.HasAnnots()) {
        x_BasicCleanupSeqAnnots(bssh);
    }

    if (bssh.IsSetDate()) {
        auto pDate = Ref(new CDate());
        pDate->Assign(bssh.GetDate());
        if (x_BasicCleanupDate(*pDate)) {
            bssh.GetEditHandle().SetDate(*pDate);
        }
    }

    x_BasicCleanupBioseqSetDescr(bssh);

    for (CSeq_entry_CI entry_it(bssh); entry_it; ++entry_it) {
        BasicCleanupSeqEntryHandle(*entry_it);
    }
    m_NewCleanup.ClearEmptyDescr(bssh);
} 
