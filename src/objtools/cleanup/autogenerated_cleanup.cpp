...
void CAutogeneratedCleanup::x_BasicCleanupSeqLocs(TContainer<CRef<CSeq_loc>>& locs)
{ // type UniSequence
    for (auto pLoc : locs) {
...
template<template<typename...> typename TContainer>
void CAutogeneratedCleanup::x_BasicCleanupSeqIds(TContainer<CRef<CSeq_id>>& ids)
{
    for (auto pId : ids) {
...
template<template<typename...> typename TContainer>
void CAutogeneratedCleanup::x_BasicCleanupDenseDiags(TContainer<CRef<CDense_diag>>& dense_diags)
{ // type UniSequence
...
template <template<typename...> typename TContainer>
void CAutogeneratedCleanup::x_BasicCleanupSeqAligns(TContainer<CRef<CSeq_align>>& aligns)
{
...
template <template<typename...> typename TContainer>
void CAutogeneratedCleanup::x_BasicCleanupSeqFeats(TContainer<CRef<CSeq_feat>>& feats)
{
