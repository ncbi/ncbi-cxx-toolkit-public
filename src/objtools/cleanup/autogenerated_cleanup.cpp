...
void CAutogeneratedCleanup::x_BasicCleanupBioseqDescr(CBioseq_Handle bsh)
{
...
void CAutogeneratedCleanup::x_BasicCleanupBioseq_inst(CBioseq_Handle bsh)
{
...
void CAutogeneratedCleanup::BasicCleanupBioseq(CBioseq& bioseq)
{
    mBiomol.reset();
