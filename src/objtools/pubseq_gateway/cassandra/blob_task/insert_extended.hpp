#ifndef OBJTOOLS__PUBSEQ_GATEWAY__CASSANDRA__BLOB_TASK__INSERT_EXTENDED_HPP
#define OBJTOOLS__PUBSEQ_GATEWAY__CASSANDRA__BLOB_TASK__INSERT_EXTENDED_HPP
...
class CCassBlobTaskInsertExtended
    : public CCassBlobWaiter
{
    enum EBlobInserterState {
        eInit = 0,
        eInsertChunks,
        eWaitingChunksInserted,
        eInsertProps,
