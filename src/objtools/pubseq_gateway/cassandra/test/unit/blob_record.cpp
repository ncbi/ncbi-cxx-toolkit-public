    ...
    TEST(BlobRecordTest, WithdrawFlags) {
        {
            ...
            EXPECT_EQ(1, a.GetIDWithdrawn());
        }
        {
            CBlobRecord a;
            a.SetFlag(true, EBlobFlags::eWithdrawnPermanently);
            EXPECT_EQ(2, a.GetIDWithdrawn());
        }
    }
