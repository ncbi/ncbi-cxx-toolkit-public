...
// tests_on_Bioseq_aa
   {"COUNT_PROTEINS", 0 | fMegaReport},
   {"MISSING_PROTEIN_ID", fDiscrepancy | fAsndisc | fMegaReport| fMegaReport},
   {"INCONSISTENT_PROTEIN_ID", fDiscrepancy| fMegaReport},
...
// tests_on_Bioseq_CFeat
   ...
   {"DISC_PRODUCT_NAME_TYPO", fDiscrepancy | fMegaReport},
   {"DISC_PRODUCT_NAME_QUICKFIX", fDiscrepancy | fMegaReport},
   ...
   {"DUP_GENPRODSET_PROTEIN", fDiscrepancy | fMegaReport},
   {"MISSING_GENPRODSET_TRANSCRIPT_ID", fDiscrepancy | fMegaReport},
   {"DISC_DUP_GENPRODSET_TRANSCRIPT_ID", fAsndisc | fMegaReport},
   {"DISC_FEAT_OVERLAP_SRCFEAT", fAsndisc | fMegaReport},
   {"CDS_TRNA_OVERLAP", 0 | fMegaReport},
   {"TRANSL_NO_NOTE", 0 | fMegaReport},
   {"NOTE_NO_TRANSL", 0 | fMegaReport},
   {"TRANSL_TOO_LONG", 0 | fMegaReport},
   ...
   {"COUNT_TRNAS", 0 | fMegaReport},
   {"FIND_DUP_TRNAS", 0 | fMegaReport},
   {"COUNT_RRNAS", 0 | fMegaReport},
   {"FIND_DUP_RRNAS", 0 | fMegaReport},
   ...
   {"DISC_CDS_PRODUCT_FIND", fOncaller},
...
// tests_on_Bioseq_CFeat_NotInGenProdSet
   ...
   {"DUPLICATE_LOCUS_TAGS", fDiscrepancy | fAsndisc | fMegaReport},
   {"DUPLICATE_LOCUS_TAGS_global", fDiscrepancy | fAsndisc | fMegaReport},
   {"INCONSISTENT_LOCUS_TAG_PREFIX", fDiscrepancy | fMegaReport},
   {"BAD_LOCUS_TAG_FORMAT", fDiscrepancy | fAsndisc | fMegaReport},
   {"FEATURE_LOCATION_CONFLICT", fDiscrepancy | fAsndisc | fMegaReport},

// tests_on_Bioseq_CFeat_CSeqdesc
   {"DISC_FEATURE_COUNT_oncaller", fOncaller | fMegaReport},  // oncaller tool version
   ...
   {"SHORT_SEQUENCES_200", fTSA | fMegaReport},
   ...
   {"TEST_BAD_GENE_NAME", fDiscrepancy | fAsndisc | fMegaReport},
   {"MOLTYPE_NOT_MRNA", fTSA | fMegaReport},
   {"TECHNIQUE_NOT_TSA", fTSA | fMegaReport},
...
// tests_on_SeqEntry
   ...
   {"DISC_FLATFILE_FIND_ONCALLER_UNFIXABLE", fOncaller | fMegaReport},
   {"DISC_FLATFILE_FIND_ONCALLER_FIXABLE", fOncaller | fMegaReport},
...
// tests_on_SeqEntry_feat_desc: all CSeqEntry_Feat_desc tests need RmvRedundancy
   ...
   {"TAX_LOOKUP_MISMATCH", fDiscrepancy | fMegaReport},
   {"MISSING_STRUCTURED_COMMENT", fTSA | fMegaReport},
...
//   {"DISC_SOURCE_QUALS_ASNDISC_oncaller", fAsndisc | fOncaller | fMegaReport}, // needed?
   ...
   {"MISSING_PROJECT", fTSA | fMegaReport},
