...
static const TKeyQualVal s_KeyQualVal[] = {
    ...
    { "unsure", "compare", "AY123456.1" },
    { "unsure", "mitochondrion", "foo" },
    { "unsure", "mobile_element", "integron" },
    { "unsure", "metagenomic", "foo" },
    { "unsure", "standard_name", "foo" },
    { "unsure", "kinetoplast", "foo" },
    { "unsure", "chromoplast", "foo" },
    { "unsure", "specific_host", "foo" },
    { "unsure", "sub_strain", "foo" },
    { "unsure", "tag_peptide", "foo" },
    { "unsure", "isolation_source", "foo" },
    { "unsure", "collected_by", "foo" },
    { "unsure", "rpt_family", "foo" },
    { "unsure", "rpt_type", "flanking" },
    { "unsure", "insertion_seq", "foo" },
    { "unsure", "transl_table", "foo" },
    { "unsure", "rearranged", "foo" },
    { "unsure", "mod_base", "foo" },
    { "unsure", "rpt_unit", "foo" },
    { "unsure", "anticodon", "foo" },
    { "unsure", "function", "foo" },
    { "unsure", "number", "foo" },
    { "unsure", "identified_by", "foo" },
    { "unsure", "collection_date", "foo" },
    { "unsure", "direction", "foo" },
    { "unsure", "rpt_unit_range", "1..3" },
    { "unsure", "serotype", "foo" },
    { "unsure", "satellite", "foo" },
    { "unsure", "organism", "foo" },
    { "unsure", "transcript_id", "foo" },
    { "unsure", "serovar", "foo" },
    { "unsure", "variety", "foo" },
    { "unsure", "country", "foo" },
    { "unsure", "rpt_unit_seq", "foo" },
    { "unsure", "lab_host", "foo" },
    { "unsure", "macronuclear", "foo" },
    { "unsure", "cyanelle", "foo" },
    { "unsure", "bio_material", "foo" },
    { "unsure", "chloroplast", "foo" },
    { "unsure", "plasmid", "foo" },
    { "unsure", "mating_type", "foo" },
    { "unsure", "cell_type", "foo" },
    { "unsure", "EC_number", "1.2.3.4" },
    { "unsure", "mol_type", "foo" },
    { "unsure", "operon", "foo" },
    { "unsure", "cultivar", "foo" },
    { "unsure", "artificial_location", "foo" },
    { "unsure", "segment", "foo" },
    { "unsure", "cons_splice", "foo" },
    { "unsure", "environmental_sample", "foo" },
    { "unsure", "PCR_conditions", "foo" },
    { "unsure", "frequency", "foo" },
    { "unsure", "transposon", "foo" },
    { "unsure", "haplogroup", "foo" },
    { "unsure", "ribosomal_slippage", "foo" },
    { "unsure", "codon_start", "foo" },
    { "unsure", "clone", "foo" },
    { "unsure", "gdb_xref", "foo" },
    { "unsure", "translation", "foo" },
    { "unsure", "transl_except", "foo" },
    { "unsure", "bound_moiety", "foo" },
    { "unsure", "sub_clone", "foo" },
    { "unsure", "cell_line", "foo" },
    { "unsure", "transgenic", "foo" },
    { "unsure", "germline", "foo" },
    { "unsure", "protein_id", "foo" },
    { "unsure", "codon", "foo" },
    { "unsure", "clone_lib", "foo" },
    { "unsure", "PCR_primers", "foo" },
    { "unsure", "sequenced_mol", "foo" },
    { "unsure", "strain", "foo" },
    { "unsure", "proviral", "foo" },
    { "unsure", "lat_lon", "foo" },
    { "unsure", "culture_collection", "foo" },
    { "unsure", "haplotype", "foo" },
    { "unsure", "estimated_length", "foo" },
    { "unsure", "tissue_lib", "foo" },
    { "unsure", "focus", "foo" },
    { "unsure", "dev_stage", "foo" },
    { "unsure", "partial", "foo" },
    { "unsure", "specimen_voucher", "foo" },
    { "unsure", "pseudo", "foo" },
    { "unsure", "isolate", "foo" },
    { "unsure", "chromosome", "foo" },
    { "unsure", "ncRNA_class", "foo" },
    { "unsure", "pop_variant", "foo" },
    { "unsure", "tissue_type", "foo" },
    { "unsure", "trans_splicing", "foo" },
    { "unsure", "organelle", "foo" },
    { "unsure", "sex", "foo" },
    { "unsure", "virion", "foo" },
    { "unsure", "sub_species", "foo" },
    { "unsure", "exception", "foo" },
    { "unsure", "phenotype", "foo" },
    { "unsure", "ecotype", "foo" },
    { "unsure", "product", "foo" },
