...
BOOST_AUTO_TEST_CASE(QueryAccSubjectAccIdentBTOPOutput) {
    ...
    BOOST_REQUIRE(output.find("AE000111	AE000447	57	89.41	28TG10GT4CA1GA8TC6-A2AT2ATA-15") != NPOS);
    BOOST_REQUIRE(output.find("AE000111	AE000116	48	98.04	38CT12") != NPOS);
    BOOST_REQUIRE(output.find("AE000111	AE000183	36	82.02	28-G1G-7AGATGT6G-3CT-T4T-1-G4-C3-T2TCACATC-14") != NPOS);
}
