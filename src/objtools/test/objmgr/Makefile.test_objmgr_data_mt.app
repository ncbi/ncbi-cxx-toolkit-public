...
CHECK_CMD = test_objmgr_data_ids.sh psg test_objmgr_data_mt /CHECK_NAME=test_objmgr_data_mt_ids_psg
...
CHECK_CMD = test_objmgr_data_mt.sh psg /CHECK_NAME=test_objmgr_data_mt_psg
CHECK_TIMEOUT = 1800
