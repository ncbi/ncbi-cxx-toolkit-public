...
CQualParser::CQualParser(
    ...
    const vector<string>& qualLines): mFeatKey(featKey), mData(qualLines)
//  ----------------------------------------------------------------------------
{
...
//  ----------------------------------------------------------------------------
{
    ...
    return CQualCleanup::CleanAndValidate(mFeatKey, qualKey, qualVal);
}
