...
typedef void (*X_gbparse_errfunc)(string_view, string_view);
...
CRef<objects::CSeq_loc> xgbparseint_ver(string_view raw_intervals, bool& keep_rawPt, int& num_errsPt, const TSeqIdList& seq_ids, bool accver);
