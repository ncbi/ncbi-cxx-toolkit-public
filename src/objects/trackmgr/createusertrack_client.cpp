...
CTMS_CreateUserTrack_Client::CTMS_CreateUserTrack_Client(const string& NS_service,
...
CTMS_CreateUserTrack_Client::CTMS_CreateUserTrack_Client(const string& NS_registry_section,
                                                         const string& NC_registry_section
                                                        )
...
CTMS_CreateUserTrack_Client::~CTMS_CreateUserTrack_Client()
{
}
