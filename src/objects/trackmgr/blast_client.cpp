...
CTMS_BLAST_Client::CTMS_BLAST_Client(const string& NS_service,
...
CTMS_BLAST_Client::CTMS_BLAST_Client(const string& NS_registry_section,
                                     const string& NC_registry_section
                                    )
...
CTMS_BLAST_Client::~CTMS_BLAST_Client()
{
}

CTMS_BLAST_Client::TReplyRef
CTMS_BLAST_Client::FetchRID(const string& rid) const
{
