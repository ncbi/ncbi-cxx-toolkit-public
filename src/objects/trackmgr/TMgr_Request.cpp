...
CRef<CTMgr_DisplayTrackRequest> CTMgr_Request::SetDefaultRequest(
    const TClient& client, const TContext& ctx, const TAssemblyAcc& assm)
{
    CRef<CTMgr_DisplayTrackRequest> tr(new CTMgr_DisplayTrackRequest());
...
/* Original file checksum: lines: 57, chars: 1753, CRC32: b8faf538 */
