 ...
 *
 * $Log$
 * Revision 6.24  2006/03/13 19:39:52  ludwigf
 * FIXED: Handling of compound values for qualifier rpt_type.
 * These compound values are generated by sequin but are not legal in our ASN
 * data definition. The fix adds BasicCleanup code that will turn such compound
 * values into repeated rpt_type qualifiers that iterate through the values of
 * the original compound list.
 *
