...
BOOST_AUTO_TEST_CASE(s_TestInt8_1)
{
    ...
    obj->ResetData();
    obj->AddField("number", "123456789", CUser_object::eParse_Number);
    TestAllFormats(*obj,
                   "User-object ::= {\n"
                   "  type id 1,\n"
                   "  data {\n"
...
BOOST_AUTO_TEST_CASE(s_TestInt8_2)
{
    ...
    obj->ResetData();
    obj->AddField("number", "12345678901235", CUser_object::eParse_Number);
    BOOST_CHECK_EQUAL(ToASNString(*obj),
                      "User-object ::= {\n"
                      "  type id 1,\n"
                      "  data {\n"
...
BOOST_AUTO_TEST_CASE(s_TestInt8_3)
{
    ...
    obj->ResetData();
    obj->AddField("number", "123456789012345679", CUser_object::eParse_Number);
    TestAllFormats(*obj,
                   "User-object ::= {\n"
                   "  type id 1,\n"
                   "  data {\n"
