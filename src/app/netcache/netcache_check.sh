...
services="`svn cat --username svnread --password allowed https://svn.ncbi.nlm.nih.gov/repos/toolkit/trunk/internal/c++/src/internal/cppcore/netcache/netcache_check_services.lst`"
test $? -eq 0 || exit 1

hosts="`svn cat --username svnread --password allowed https://svn.ncbi.nlm.nih.gov/repos/toolkit/trunk/internal/c++/src/internal/cppcore/netcache/netcache_check_servers.lst`"
test $? -eq 0 || exit 2
