...
struct SCommandDefinition {
    ...
    {eSubmitterCommand, &CGridCommandLineInterfaceApp::Cmd_SubmitJob,
        ...
        "by the 'remote_app' worker node. The standard input stream (or "
        "'--" INPUT_OPTION "', or '--" INPUT_FILE_OPTION "') is captured "
        "and passed as the standard input stream of the remote_app job.\n\n"
