...
const string            kDefaultLMDBProcessorHealthCommand = "/ID/resolve?seq_id=gi|2&use_cache=yes&disable_processor=wgs";
const double            kDefaultLMDBHealthTimeoutSec = 0.0;
const string            kDefaultCassandraProcessorHealthCommand = "/ID/resolve?seq_id=gi|2&use_cache=no&disable_processor=wgs";
