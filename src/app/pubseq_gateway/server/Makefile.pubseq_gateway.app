...
SRC = pubseq_gateway  \
      ...
      ipg_resolve settings my_ncbi_cache myncbi_callback
...
LIBS = $(PCRE_LIBS) $(OPENSSL_LIBS) $(H2O_STATIC_LIBS) $(CASSANDRA_STATIC_LIBS) \
       ...
       $(NETWORK_LIBS) $(CMPRS_LIBS) $(SRA_SDK_SYSLIBS) $(GRPC_LIBS) $(CURL_LIBS) $(ORIG_LIBS)
...
LIB = $(SRAREAD_LIBS) dbsnp_ptis grpc_integration sraread \
      ...
      xcgi psg_myncbi xmlwrapp xconnext connext xconnserv xconnect xcompress xutil xncbi
