...
constexpr string_view     kAccessionItem = "\"accession\": ";
constexpr string_view     kVersionItem = "\"version\": ";
constexpr string_view     kSeqIdTypeItem = "\"seq_id_type\": ";
constexpr string_view     kNameItem = "\"name\": ";
constexpr string_view     kGiItem = "\"gi\": ";
constexpr string_view     kDateChangedItem = "\"date_changed\": ";
constexpr string_view     kHashItem = "\"hash\": ";
constexpr string_view     kLengthItem = "\"length\": ";
constexpr string_view     kMolItem = "\"mol\": ";
constexpr string_view     kSatItem = "\"sat\": ";
constexpr string_view     kSatKeyItem = "\"sat_key\": ";
constexpr string_view     kBlobIdItem = "\"blob_id\": ";
constexpr string_view     kSeqIdsItem = "\"seq_ids\": ";
constexpr string_view     kSeqStateItem = "\"seq_state\": ";
constexpr string_view     kStateItem = "\"state\": ";
constexpr string_view     kTaxIdItem = "\"tax_id\": ";
constexpr string_view     kSep = ", ";
constexpr string_view     kDictValueSep = ": ";
constexpr string_view     kKeyItem = "\"key\": ";
constexpr string_view     kLastModifiedItem = "\"last_modified\": ";
constexpr string_view     kFlagsItem = "\"flags\": ";
constexpr string_view     kSizeItem = "\"size\": ";
constexpr string_view     kSizeUnpackedItem = "\"size_unpacked\": ";
constexpr string_view     kClassItem = "\"class\": ";
constexpr string_view     kDateAsn1Item = "\"date_asn1\": ";
constexpr string_view     kHupDateItem = "\"hup_date\": ";
constexpr string_view     kDivItem = "\"div\": ";
constexpr string_view     kId2InfoItem = "\"id2_info\": ";
constexpr string_view     kOwnerItem = "\"owner\": ";
constexpr string_view     kUserNameItem = "\"username\": ";
constexpr string_view     kNChunksItem = "\"n_chunks\": ";
constexpr string_view     kStartItem = "\"start\": ";
constexpr string_view     kStopItem = "\"stop\": ";
constexpr string_view     kAnnotInfoItem = "\"annot_info\": ";
constexpr string_view     kSeqAnnotInfoItem = "\"seq_annot_info\": ";
constexpr string_view     kRequestItem = "\"request\": ";
constexpr string_view     kDatacenterItem = "\"datacenter\": ";
constexpr string_view     kSecSeqIdItem = "\"sec_seq_id\": ";
constexpr string_view     kSecSeqIdTypeItem = "\"sec_seq_id_type\": ";
constexpr string_view     kSecSeqStateItem = "\"sec_seq_state\": ";
constexpr string_view     kSatNameItem = "\"sat_name\": ";
constexpr string_view     kChunksRequestedItem = "\"chunk_requested\": ";
constexpr string_view     kBlopPropProvidedItem = "\"blob_prop_provided\": ";
constexpr string_view     kSplitVersionItem = "\"split_version\": ";
constexpr string_view     kAnnotNamesItem = "\"annotation_names\": ";
constexpr string_view     kDateItem = "\"date\": ";
constexpr string_view     kChainItem = "\"chain\": ";
constexpr string_view     kIPGItem = "\"ipg\": ";
constexpr string_view     kProteinItem = "\"protein\": ";
constexpr string_view     kNucleotideItem = "\"nucleotide\": ";
constexpr string_view     kProductNameItem = "\"product_name\": ";
constexpr string_view     kDivisionItem = "\"division\": ";
constexpr string_view     kAssemblyItem = "\"assembly\": ";
constexpr string_view     kStrainItem = "\"strain\": ";
constexpr string_view     kBioProjectItem = "\"bio_project\": ";
constexpr string_view     kGBStateItem = "\"gb_state\": ";
...
constexpr string_view     kIdItem = "\"id\": ";
constexpr string_view     kConnCntAtOpenItem = "\"conn_cnt_at_open\": ";
constexpr string_view     kOpenTimestampItem = "\"open_timestamp\": ";
constexpr string_view     kLastRequestTimestampItem = "\"last_request_timestamp\": ";
constexpr string_view     kFinishedReqsCntItem = "\"finished_reqs_cnt\": ";
constexpr string_view     kRejectedDueToSoftLimitReqsCntItem = "\"rejected_due_to_soft_limit_reqs_cnt\": ";
constexpr string_view     kBacklogReqsCntItem = "\"backlog_reqs_cnt\": ";
constexpr string_view     kRunningReqsCntItem = "\"running_reqs_cnt\": ";
constexpr string_view     kPeerIpItem = "\"peer_ip\": ";
constexpr string_view     kExceedSoftLimitFlagItem = "\"exceed_soft_limit_flag\": ";
constexpr string_view     kMovedFromBadToGoodItem = "\"moved_from_bad_to_good\": ";
constexpr string_view     kPeerIdItem = "\"peer_id\": ";
constexpr string_view     kPeerUserAgentItem = "\"peer_user_agent\": ";
