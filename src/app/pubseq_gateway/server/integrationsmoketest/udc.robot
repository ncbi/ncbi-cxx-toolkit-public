...
| Documentation | Integration smoke tests for PSG server |
...
| ${PARAMS}                | ${SERVICE}                     | # Parameters for finding server
| ${APP_BN}                | ${TEST_APPS_DIR}${APP_NAME} -service ${PARAMS} | # Path to the application |
