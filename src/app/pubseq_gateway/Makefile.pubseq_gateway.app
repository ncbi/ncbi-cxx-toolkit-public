...
SRC = pubseq_gateway  \
      ...
      uv_extra pubseq_gateway_utils pubseq_gateway_stat resolver_handler
...
LIB = psg_cache $(SEQ_LIBS) pub medline biblio general xser psg_rpc psg_cassandra connext xconnserv xconnect xutil xncbi
