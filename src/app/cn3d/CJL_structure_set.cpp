...
void StructureSet::Load(int structureLimit)
{
    ...
    if (sequenceSet) {
        ...
        if (alignmentManager) alignmentManager->structureSet_Hack = this;  //  CJL hack so can grab hold of a StructureSet
    }
...
StructureSet::SeqEntryList* StructureSet::GetASNSequences() {return (dataManager) ? dataManager->GetSequences() : NULL; }
StructureSet::SeqAnnotList* StructureSet::GetASNAlignment() {return (dataManager) ? dataManager->GetOrCreateSequenceAlignments() : NULL; }
...
* ---------------------------------------------------------------------------
* $Log$
* Revision 1.1  2005/10/19 16:37:18  lanczyck
* temporary files:  refiner-related modifications
*
