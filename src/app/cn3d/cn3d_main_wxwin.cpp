...
static bool LoadFavorites(void)
{
    string favoritesFile = registry.Get(REG_CONFIG_SECTION, REG_FAVORITES_NAME);
...
void Cn3DMainFrame::OnSetFont(wxCommandEvent& event)
{
    ...
    {
        ERRORMSG("Cn3DMainFrame::OnSetFont() - error setting up initial font");
        return;
    }
    ...
    if (result == wxID_OK) {
        ...
        {
            ERRORMSG("Cn3DMainFrame::OnSetFont() - error setting registry data");
            return;
        }
...
*
* Revision 1.179  2003/02/03 19:20:02  thiessen
