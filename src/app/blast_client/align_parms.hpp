#ifndef APP_BLAST_CLIENT___ALIGN_PARMS__HPP
#define APP_BLAST_CLIENT___ALIGN_PARMS__HPP
...
/// designed to isolate blast_client from these changes.  It also
/// serves to collect knowledge of the formatting interfaces in one
/// part of the blast_client application.
