#ifndef APP_BLAST_CLIENT___OPTIONAL__HPP
#define APP_BLAST_CLIENT___OPTIONAL__HPP
...
/// Optional value idiom for blast_client.
///
...
/// important to blast_client because of the design of the blast4
