...
#ifndef APP__BLASTX_NODE__HPP
#define APP__BLASTX_NODE__HPP
...
class CBlastxNode : public CBlastNode
{
public :
...
protected:
   	virtual ~CBlastxNode(void);
   	virtual void* Main(void);
private:
	string m_Input;
	CRef<CBlastxNodeArgs>  m_CmdLineArgs;
};

END_SCOPE(blast)
END_NCBI_SCOPE

#endif /* APP__BLASTX_NODE__HPP */
