...
#ifndef _APP_BLAST__MULTISOURCE_UTIL_HPP_
#define _APP_BLAST__MULTISOURCE_UTIL_HPP_
...
void GetDeflineKeys(const CBlast_def_line & defline,
                    vector<string>        & keys);
...
public:
    ...
    void AppendSeqId(CRef<CSeq_id> seqid, int oid = -1)
    {
...
void GetSeqIdKey(const CSeq_id & id, string & key);

string AccessionToKey(const string & acc);

#endif // _APP_BLAST__MULTISOURCE_UTIL_HPP_
