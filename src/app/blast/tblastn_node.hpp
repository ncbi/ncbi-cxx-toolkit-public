...
#ifndef APP__TBLASTN_NODE__HPP
#define APP__TBLASTN_NODE__HPP
...
class CTblastnNode : public CBlastNode
{
public :

	CTblastnNode (int check_num, const CNcbiArguments & ncbi_args, const CArgs& args,
