...
2).    Igblast internal data (supplied with igblast program under internal_data subdirectory).  These files or their locations should NOT be edited.
...
The entry format has tab-delimited fields for sequence id and coding frame start position.  See human_gl.aux or mouse_gl.aux for examples.  Enter -1 if the frame information is unknown.  You need to use -auxilary_data option to specify your file.
...
./igblastn -germline_db_V database/human_gl_V -germline_db_J database/human_gl_J -germline_db_D database/human_gl_D -organism human -domain_system kabat -query myseq -auxilary_data optional_file/human_gl.aux -show_translation -outfmt 3
...
./igblastn -germline_db_V database/human_gl_V -germline_db_J database/human_gl_J -germline_db_D database/human_gl_D -organism human -domain_system kabat -query myseq -auxilary_data optional_file/human_gl.aux -show_translation -outfmt 7
...
./igblastn -germline_db_V database/UNSWIgVRepertoire_fasta.txt -germline_db_J database/UNSWIgJRepertoire_fasta.txt -germline_db_D database/UNSWIgDRepertoire_fasta.txt -organism human -domain_system kabat -query myseq  -auxilary_data optional_file/human_gl.aux -show_translation
...
./igblastn -germline_db_V database/human_gl_V -germline_db_J database/human_gl_J -germline_db_D database/human_gl_D -query myseq -auxilary_data optional_file/human_gl.aux  -show_translation -db database/igSeqNt -num_alignments 10 -outfmt 3

b).  To query one or more human Ig sequences (contained in myseq) against NCBI  nr database:
./igblastn -germline_db_V database/human_gl_V -germline_db_J database/human_gl_J -germline_db_D database/human_gl_D -query myseq -auxilary_data optional_file/human_gl.aux  -show_translation -db nr -num_alignments 10 -remote -outfmt 3
...
2).  Searching other databases in addition to germline database.
 ./igblastp -germline_db_V database/human_gl_V -query myseq  -db database/igSeqProt -outfmt 3
