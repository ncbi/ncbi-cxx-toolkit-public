...
// Storage
#define NETSCHEDULED_STORAGE_VERSION_MAJOR  5
#define NETSCHEDULED_STORAGE_VERSION_MINOR  0
#define NETSCHEDULED_STORAGE_VERSION_PATCH  0
...
#define NETSCHEDULED_PROTOCOL_VERSION_PATCH 6
