...
* ===========================================================================
*
* $Log: read_parents.cpp,v $
* Revision 1.1  2007/09/20 14:40:44  badrazat
* read routines to their own files
*
* Revision 1.4  2007/07/25 12:40:41  badrazat
* read_parents.cpp: renaming some routines
* read_parents.cpp: attempt at smarting up RemoveInterim: nothing has been done
...
* new file cut_blast_output_qnd and some changes to read_parents.cpp
*
