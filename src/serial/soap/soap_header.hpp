...
class CSoapHeader : public ncbi::CSerialObject
{
...
inline
const ncbi::CAnyContentObject& CSoapHeader::C_E::GetAnyContent(void) const
{
    if (!CanGetAnyContent()) {
        ThrowUnassigned(0);
    }
...
inline
ncbi::CAnyContentObject& CSoapHeader::C_E::SetAnyContent(void)
{
    return (*m_AnyContent);
}
...
inline
const std::list< ncbi::CRef< CSoapHeader::C_E > >& CSoapHeader::Get(void) const
{
    return m_data;
}

inline
std::list< ncbi::CRef< CSoapHeader::C_E > >& CSoapHeader::Set(void)
{
    m_set_State[0] |= 0x1;
    return m_data;
}
...
inline
CSoapHeader::operator const std::list< ncbi::CRef< CSoapHeader::C_E > >& (void) const
{
    return m_data;
}

inline
CSoapHeader::operator std::list< ncbi::CRef< CSoapHeader::C_E > >& (void)
{
    m_set_State[0] |= 0x1;
    return m_data;
}
