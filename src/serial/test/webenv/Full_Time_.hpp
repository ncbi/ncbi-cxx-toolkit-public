...
public:
    ...
    void SetYear(const TYear& value);
    TYear& SetYear(void);
    ...
    void SetMonth(const TMonth& value);
    ...
    void SetHour(const THour& value);
    THour& SetHour(void);
    ...
    void SetMinute(const TMinute& value);
    ...
    void SetSecond(const TSecond& value);
...
inline
void CFull_Time_Base::SetYear(const int& value)
{
    m_Year = value;
    m_set_State[0] |= 0x3;
}
...
inline
void CFull_Time_Base::SetMonth(const int& value)
{
    m_Month = value;
    m_set_State[0] |= 0xc;
}
...
inline
void CFull_Time_Base::SetDay(const int& value)
{
    m_Day = value;
    m_set_State[0] |= 0x30;
}
...
inline
void CFull_Time_Base::SetHour(const int& value)
{
    m_Hour = value;
    m_set_State[0] |= 0xc0;
}
...
inline
void CFull_Time_Base::SetMinute(const int& value)
{
    m_Minute = value;
    m_set_State[0] |= 0x300;
}
...
inline
void CFull_Time_Base::SetSecond(const int& value)
{
    m_Second = value;
    m_set_State[0] |= 0xc00;
}
