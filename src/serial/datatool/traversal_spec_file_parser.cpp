 ...
 * the auto-generated code.  After this, there aren't restrictions on order and you can place clauses of any type in any order.
 * 
 ...
 * the need to explicitly call cleanup.  You may want to use POST because you want your children
 ...
 * member name (e.g. "location"), or a C++ class name (e.g. "CSeq_loc" ), or a "?", which means
...
##### ILLEGAL SYNTAX
use m_NewCleanup.ProtFeatfBC { Seq-feat.data.prot, ftable }
...
void CTraversalSpecFileParser::x_ParseOutputClassNameClause( CTokenizer &tokenizer )
{
    ...
    tokenizer.GetNextOrThrow( m_OutputClassName );
