...
CHECK_CMD = test_ncbidiag_mt.sh -format old -async /CHECK_NAME=test_ncbidiag_mt_old_async
CHECK_CMD = test_ncbidiag_mt.sh -format new /CHECK_NAME=test_ncbidiag_mt_new_fmt
CHECK_CMD = test_ncbidiag_mt.sh -format new -async /CHECK_NAME=test_ncbidiag_mt_new_async
