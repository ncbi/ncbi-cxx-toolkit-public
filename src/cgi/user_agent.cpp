...
const SBrowser s_Browsers[] = {
    ...
    { CCgiUserAgent::eCrawler,      "DuckDuckBot",              "DuckDuckBot",              CCgiUserAgent::eEngine_Bot,     CCgiUserAgent::ePlatform_Unknown,      fAny },
    ...
    { CCgiUserAgent::eCrawler,      "Facebook External Hit",    "facebot",                  CCgiUserAgent::eEngine_Bot,     CCgiUserAgent::ePlatform_Unknown,      fApp },
    { CCgiUserAgent::eCrawler,      "Facebook External Hit",    "facebookexternalhit",      CCgiUserAgent::eEngine_Bot,     CCgiUserAgent::ePlatform_Unknown,      fApp },
    ...
    { CCgiUserAgent::eCrawler,      "Alexa Crawler",            "ia_archiver",              CCgiUserAgent::eEngine_Bot,     CCgiUserAgent::ePlatform_Unknown,      fAppProduct },
    ...
    { CCgiUserAgent::eCrawler,      "Sogou Spider",             "Sogou",                    CCgiUserAgent::eEngine_Bot,     CCgiUserAgent::ePlatform_Unknown,      fApp },
    ...
    { CCgiUserAgent::eCrawler,      "Yandex",                   "yandex",                   CCgiUserAgent::eEngine_Bot,     CCgiUserAgent::ePlatform_Unknown,      fAny },
    ...
    { CCgiUserAgent::eScript,       "Jakarta Commons HttpClient","Apache-HttpClient",       CCgiUserAgent::eEngine_Bot,     CCgiUserAgent::ePlatform_Unknown,      fAny },
    { CCgiUserAgent::eScript,       "Jakarta Commons HttpClient","Jakarta Commons-HttpClient",CCgiUserAgent::eEngine_Bot,   CCgiUserAgent::ePlatform_Unknown,      fAny },
