 ...
 *
 * File Description:  Cloudflare ZLib Compression API wrapper
 *
...
CZipCloudflareCompression::CZipCloudflareCompression(ELevel level)
    : CCompression(level)
{
...
CZipCloudflareCompression::~CZipCloudflareCompression()
{
    delete STREAM;
    return;
}
...
size_t s_CheckGZipHeader(const void* src_buf, size_t src_len,
                         CZipCloudflareCompression::SFileInfo* info = 0)
{
...
size_t s_WriteGZipHeader(void* dst_buf, size_t dst_size,
                         const CZipCloudflareCompression::SFileInfo* info = 0)
{
...
static
void s_CollectFileInfo(const string& filename, CZipCloudflareCompression::SFileInfo& info)
{
    CFile file(filename);
...
CVersionInfo CZipCloudflareCompression::GetVersion(void) const
{
    return CVersionInfo(ZLIB_VER_MAJOR, ZLIB_VER_MINOR, ZLIB_VER_REVISION, "zlib");
}


bool CZipCloudflareCompression::HaveSupport(ESupportFeature feature)
{
    switch (feature) {
...
bool CZipCloudflareCompression::CompressBuffer(
        const void* src_buf, size_t  src_len,
        void*       dst_buf, size_t  dst_size,
        /* out */   size_t* dst_len)
{
    const char* __method_name = "CZipCloudflareCompression::CompressBuffer";
    *dst_len = 0;
    ...
    if ( errcode != Z_STREAM_END) {
        ERR_COMPRESS(53, FormatErrorMessage("CZipCloudflareCompression::CompressBuffer"));
        return false;
    }
    ...
    if ( F_ISSET(fWriteGZipFormat) ) {
        ...
        if ( !footer_len ) {
            ...
            ERR_COMPRESS(54, FormatErrorMessage("CZipCloudflareCompressor::CompressBuffer"));
            return false;
        }
        *dst_len += footer_len;
    }
...
bool CZipCloudflareCompression::DecompressBuffer(
        const void* src_buf, size_t  src_len,
        void*       dst_buf, size_t  dst_size,
        /* out */            size_t* dst_len)
{
    const char* __method_name = "CZipCloudflareCompression::DecompressBuffer";
    *dst_len = 0;
...
size_t CZipCloudflareCompression::EstimateCompressionBufferSize(size_t src_len)
{
...
CZipCloudflareCompression::GetRecommendedBufferSizes(size_t round_up)
{
...
bool CZipCloudflareCompression::CompressFile(
...
{
    CZipCloudflareCompressionFile cf(GetLevel());
    ...
    CZipCloudflareCompression::SFileInfo info;
...
bool CZipCloudflareCompression::DecompressFile(
        const string& src_file,
        const string& dst_file,
        size_t        file_io_bufsize,
...
bool CZipCloudflareCompression::DecompressFileIntoDir(
        const string& src_file,
...
bool CZipCloudflareCompression::SetDictionary(CCompressionDictionary& dict, ENcbiOwnership own)
{
...
string CZipCloudflareCompression::FormatErrorMessage(string where, size_t pos) const
{
...
int CZipCloudflareCompression::GetStrategyDefault(void)    { return Z_DEFAULT_STRATEGY; };
int CZipCloudflareCompression::GetStrategyMin(void)        { return Z_DEFAULT_STRATEGY; /* 0 */ };

int CZipCloudflareCompression::GetStrategyMax(void)
{
...
int CZipCloudflareCompression::GetWindowBitsDefault(void)  { return MAX_WBITS; };
int CZipCloudflareCompression::GetWindowBitsMin(void)      { return DEF_WBITS; };
int CZipCloudflareCompression::GetWindowBitsMax(void)      { return MAX_WBITS; };

int CZipCloudflareCompression::GetMemoryLevelDefault(void) { return DEF_MEM_LEVEL; };
int CZipCloudflareCompression::GetMemoryLevelMin(void)     { return 1; };
int CZipCloudflareCompression::GetMemoryLevelMax(void)     { return MAX_MEM_LEVEL; };
...
CZipCloudflareCompressionFile::CZipCloudflareCompressionFile(ELevel level)
...
CZipCloudflareCompressionFile::~CZipCloudflareCompressionFile(void)
{
    ...
    COMPRESS_HANDLE_EXCEPTIONS(92, "CZipCloudflareCompressionFile::~CZipCloudflareCompressionFile");
    return;
}
...
bool CZipCloudflareCompressionFile::Open(
        ...
        size_t compression_in_bufsize, size_t compression_out_bufsize)
{
    ...
    if ( mode == eMode_Read ) {
        CZipCloudflareDecompressor* decompressor = new CZipCloudflareDecompressor(GetFlags());
        ...
        CZipCloudflareCompressor* compressor = new CZipCloudflareCompressor(GetLevel(), GetFlags());
...
long CZipCloudflareCompressionFile::Read(void* buf, size_t len)
{
    ...
    if ( !m_Stream  ||  m_Mode != eMode_Read ) {
        NCBI_THROW(CCompressionException, eCompressionFile, 
            "[CZipCloudflareCompressionFile::Read]  File must be opened for reading");
    }
    if ( !m_Stream->good() ) {
        return 0;
    }
...
long CZipCloudflareCompressionFile::Write(const void* buf, size_t len)
{
    if ( !m_Stream  ||  m_Mode != eMode_Write ) {
        NCBI_THROW(CCompressionException, eCompressionFile, 
            "[CZipCloudflareCompressionFile::Write]  File must be opened for writing");
    }
...
bool CZipCloudflareCompressionFile::Close(void)
{
...
CZipCloudflareCompressor::CZipCloudflareCompressor(ELevel level, TZipFlags flags)
    : CZipCloudflareCompression(level),
...
CZipCloudflareCompressor::~CZipCloudflareCompressor()
{
}
...
CCompressionProcessor::EStatus CZipCloudflareCompressor::Init(void)
{
    if ( IsBusy() ) {
    ...
    ERR_COMPRESS(60, FormatErrorMessage("CZipCloudflareCompressor::Init", GetProcessedSize()));
    return eStatus_Error;
}


CCompressionProcessor::EStatus CZipCloudflareCompressor::Process(
        ...
        /* out */            size_t* out_avail)
{
    *out_avail = 0;
    ...
    if ( F_ISSET(fWriteGZipFormat)  &&  m_NeedWriteHeader ) {
        ...
        if (!header_len) {
            ...
            ERR_COMPRESS(62, FormatErrorMessage("CZipCloudflareCompressor::Process", GetProcessedSize()));
            return eStatus_Error;
        }
    ...
    *out_avail = out_size - STREAM->avail_out;
    ...
    ERR_COMPRESS(63, FormatErrorMessage("CZipCloudflareCompressor::Process", GetProcessedSize()));
    return eStatus_Error;
}


CCompressionProcessor::EStatus CZipCloudflareCompressor::Flush(
        char* out_buf, size_t  out_size,
        /* out */      size_t* out_avail)
{
    *out_avail = 0;
    ...
    *out_avail = out_size - STREAM->avail_out;
    ...
    ERR_COMPRESS(64, FormatErrorMessage("CZipCloudflareCompressor::Flush", GetProcessedSize()));
    return eStatus_Error;
}


CCompressionProcessor::EStatus CZipCloudflareCompressor::Finish(
        char* out_buf, size_t  out_size,
        /* out */      size_t* out_avail)
{
    *out_avail = 0;
    ...
    *out_avail = out_size - STREAM->avail_out;
    ...
    ERR_COMPRESS(66, FormatErrorMessage("CZipCloudflareCompressor::Finish", GetProcessedSize()));
    return eStatus_Error;
}


CCompressionProcessor::EStatus CZipCloudflareCompressor::End(int abandon)
{
    ...
    ERR_COMPRESS(67, FormatErrorMessage("CZipCloudflareCompressor::End", GetProcessedSize()));
    return eStatus_Error;
}
...
CZipCloudflareDecompressor::CZipCloudflareDecompressor(TZipFlags flags)
    : CZipCloudflareCompression(eLevel_Default),
...
CZipCloudflareDecompressor::~CZipCloudflareDecompressor()
{
    if ( IsBusy() ) {
...
CCompressionProcessor::EStatus CZipCloudflareDecompressor::Init(void)
{
    // Initialize members
    Reset();
    SetBusy();
    ...
    ERR_COMPRESS(68, FormatErrorMessage("CZipCloudflareDecompressor::Init", GetProcessedSize()));
    return eStatus_Error;
}


CCompressionProcessor::EStatus CZipCloudflareDecompressor::Process(
        const char* in_buf,  size_t  in_len,
        char*       out_buf, size_t  out_size,
        /* out */            size_t* in_avail,
        /* out */            size_t* out_avail)
    ...
    if ( m_DecompressMode != eMode_TransparentRead ) {
        ...
        if ( m_DecompressMode == eMode_Decompress ) {
            ...
            *out_avail = out_size - STREAM->avail_out;
            ...
            ERR_COMPRESS(70, FormatErrorMessage("CZipCloudflareDecompressor::Process", GetProcessedSize()));
            return eStatus_Error;
        }
...
CCompressionProcessor::EStatus CZipCloudflareDecompressor::Flush(
        char*   out_buf,
        size_t  out_size,
        size_t* out_avail)
{
...
CCompressionProcessor::EStatus CZipCloudflareDecompressor::Finish(
        char*   out_buf,
        size_t  out_size,
        size_t* out_avail)
{
...
CCompressionProcessor::EStatus CZipCloudflareDecompressor::End(int abandon)
{
    ...
    ERR_COMPRESS(71, FormatErrorMessage("CZipCloudflareDecompressor::End", GetProcessedSize()));
    return eStatus_Error;
}
