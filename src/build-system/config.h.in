...
/* Define to 1 if you have the declaration of `CLOCK_SGI_CYCLE', and to 0 if
   you don't. */
#undef HAVE_DECL_CLOCK_SGI_CYCLE
...
/* Define to 1 if you have the <gsl/gsl> header file. */
#undef HAVE_GSL_GSL
...
/* Define to 1 if libaws-cpp-sdk-s3 is available. */
#undef HAVE_LIBAWS_SDK
...
/* Define to 1 if libcassandra is available. */
#undef HAVE_LIBCASSANDRA
...
/* Define to 1 if libdw is available. */
#undef HAVE_LIBDW
...
/* Define to 1 if libh2o is available. */
#undef HAVE_LIBH2O

/* Define to 1 if libhdf5_cpp is available. */
#undef HAVE_LIBHDF5

/* Define to 1 if libhiredis is available. */
...
/* Define to 1 if libleveldb is available. */
...
/* Define to 1 if libmbedtls is available. */
...
/* Define to 1 if libmongocxx is available. */
#undef HAVE_LIBMONGODB3
...
/* Define to 1 if libncbi-ngs-c++ is available. */
#undef HAVE_LIBNGS
...
/* Define to 1 if libssh2 is available. */
#undef HAVE_LIBSSH2
...
/* Define to 1 if libxlsxwriter is available. */
#undef HAVE_LIBXLSXWRITER
...
#undef NCBI_EXPECTED_BOOST_VERSION
...
/* Define to 1 if using a local copy of LMDB. */
#undef USE_LOCAL_LMDB
