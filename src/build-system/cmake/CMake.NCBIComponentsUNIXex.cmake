...
set(NCBI_ThirdParty_Boring       ${NCBI_TOOLS_ROOT}/grpc-1.28.1-ncbi1)
...
set(NCBI_ThirdParty_GTEST        ${NCBI_TOOLS_ROOT}/googletest-1.8.1)
...
# XSLT
if(ON)
    NCBI_find_package(XSLT libexslt)
else()
    if (NCBI_COMPONENT_GCRYPT_FOUND)
...
message("NCBI_COMPONENT_GLEW_INCLUDE = ${NCBI_COMPONENT_GLEW_INCLUDE}")
        endif()
    endif()
else()
