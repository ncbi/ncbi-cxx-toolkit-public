...
if (${CMAKE_SYSTEM_NAME} MATCHES "Linux")
  set(NCBI_ThirdParty_Boost_VERSION "1.89.0")
else()
...
if (${CMAKE_SYSTEM_NAME} MATCHES "Linux")
  set(NCBI_ThirdParty_FASTCGI       ${NCBI_TOOLS_ROOT}/fcgi-2.4.7 CACHE PATH "FASTCGI root")
else()
...
set(NCBI_ThirdParty_PYTHON_VERSION "3.13")
...
if (${CMAKE_SYSTEM_NAME} MATCHES "Linux")
  set(NCBI_ThirdParty_GRPC          ${NCBI_TOOLS_ROOT}/grpc-1.67.1-ncbi2 CACHE PATH "GRPC root")
  set(NCBI_ThirdParty_PROTOBUF      ${NCBI_TOOLS_ROOT}/grpc-1.67.1-ncbi2 CACHE PATH "GRPC root")
else()
...
set(NCBI_ThirdParty_GFlags        ${NCBI_TOOLS_ROOT}/gflags-2.2.2 CACHE PATH "GFlags root")
...
set(NCBI_ThirdParty_MONGOCXX      ${NCBI_TOOLS_ROOT}/mongodb-3.11.0-ncbi1 CACHE PATH "MONGOCXX root")
set(NCBI_ThirdParty_MONGOC        ${NCBI_TOOLS_ROOT}/mongo-c-driver-1.30.5 CACHE PATH "MONGOC root")
...
set(NCBI_ThirdParty_ROCKSDB       ${NCBI_TOOLS_ROOT}/rocksdb-10.5.1 CACHE PATH "ROCKSDB root")
...
if (${CMAKE_SYSTEM_NAME} MATCHES "Linux")
  set(NCBI_ThirdParty_UV            ${NCBI_TOOLS_ROOT}/libuv-1.51.0 CACHE PATH "UV root")
elseif(APPLE)
...
if (${CMAKE_SYSTEM_NAME} MATCHES "Linux")
  set(NCBI_ThirdParty_NGHTTP2       ${NCBI_TOOLS_ROOT}/nghttp2-1.67.0 CACHE PATH "NGHTTP2 root")
else()
  set(NCBI_ThirdParty_NGHTTP2       ${NCBI_TOOLS_ROOT}/nghttp2-1.40.0 CACHE PATH "NGHTTP2 root")
endif()
if (${CMAKE_SYSTEM_NAME} MATCHES "Linux")
  set(NCBI_ThirdParty_GL2PS         ${NCBI_TOOLS_ROOT}/gl2ps-1.4.2 CACHE PATH "GL2PS root")
else()
  set(NCBI_ThirdParty_GL2PS         ${NCBI_TOOLS_ROOT}/gl2ps-1.4.0 CACHE PATH "GL2PS root")
endif()
set(NCBI_ThirdParty_GMOCK         ${NCBI_TOOLS_ROOT}/googletest-1.12.1 CACHE PATH "GMOCK root")
set(NCBI_ThirdParty_GTEST         ${NCBI_TOOLS_ROOT}/googletest-1.12.1 CACHE PATH "GTEST root")
set(NCBI_ThirdParty_CASSANDRA     ${NCBI_TOOLS_ROOT}/datastax-cpp-driver-2.17.1-ncbi1b CACHE PATH "CASSANDRA root")
if (${CMAKE_SYSTEM_NAME} MATCHES "Linux")
  set(NCBI_ThirdParty_H2O           ${NCBI_TOOLS_ROOT}/h2o-2.2.6-ncbi3+uv1.51 CACHE PATH "H2O root")
else()
...
set(NCBI_ThirdParty_THRIFT        ${NCBI_TOOLS_ROOT}/thrift-0.22.0 CACHE PATH "THRIFT root")
set(NCBI_ThirdParty_NLohmann_JSON ${NCBI_TOOLS_ROOT}/nlohmann-json-3.12.0 CACHE PATH "NLohmann_JSON root")
...
set(NCBI_ThirdParty_JAEGER        ${NCBI_TOOLS_ROOT}/jaeger-client-cpp-0.9.0 CACHE PATH "JAEGER root")
set(NCBI_ThirdParty_OPENTELEMETRY ${NCBI_TOOLS_ROOT}/opentelemetry-cpp-1.20.0 CACHE PATH "OPENTELEMETRY root")
...
if(NOT HAVE_BACKWARD_HPP)
    if(TARGET Backward::Backward)
        get_target_property(_inc Backward::Backward INTERFACE_INCLUDE_DIRECTORIES)
        check_include_file_cxx(backward.hpp HAVE_BACKWARD_HPP "-I${_inc}")
    else()
...
if(NOT NCBI_COMPONENT_IPS4O_FOUND)
    ...
    if(NOT HAVE_IPS4O_HPP)
        if(TARGET ips4o::ips4o)
            get_target_property(_inc ips4o::ips4o INTERFACE_INCLUDE_DIRECTORIES)
            check_include_file_cxx(ips4o.hpp HAVE_IPS4O_HPP "-I${_inc} -I${TBB_INCLUDE_DIR}")
        else()
            check_include_file_cxx(ips4o.hpp HAVE_IPS4O_HPP "-I${TBB_INCLUDE_DIR}")
        endif()
    endif()
endif()
...
if(NOT NCBI_COMPONENT_ARROW_FOUND)
    ...
    if(NCBI_PTBCFG_COMPONENT_StaticComponents)
        target_compile_definitions(arrow::arrow INTERFACE PARQUET_STATIC ARROW_STATIC)
    endif()
endif()
