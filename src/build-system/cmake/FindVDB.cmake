IF (UNIX AND NOT APPLE)
  if (EXISTS /opt/ncbi/64/trace_software/vdb/vdb-versions/2.7.0/interfaces)
    set(VDB_FOUND true)
    set(VDB_INCLUDE /opt/ncbi/64/trace_software/vdb/vdb-versions/2.7.0/interfaces)
    set(VDB_LIB "")
...
IF (APPLE)
  if (EXISTS /net/snowman/vol/projects/trace_software/vdb/vdb-versions/2.7.0/mac/debug/x86_64/lib)
    set(VDB_FOUND true)
    set(VDB_INCLUDE /net/snowman/vol/projects/trace_software/vdb/vdb-versions/2.7.0/interfaces /net/snowman/vol/projects/trace_software/vdb/vdb-versions/2.7.0/interfaces/cc/gcc)
    set(VDB_LIB "")
    ...
    set(VDB_STATIC_LIBS -L/net/snowman/vol/projects/trace_software/vdb/vdb-versions/2.7.0/mac/debug/x86_64/lib -Wl,-rpath,/net/snowman/vol/projects/trace_software/vdb/vdb-versions/cxx_toolkit/2/mac/debug/x86_64/lib -lncbi-vdb -L/netopt/ncbi_tools/libxml-2.7.8/GCC401-DebugMTUniv/lib -Wl,-rpath,/netopt/ncbi_tools/libxml-2.7.8/GCC401-DebugMTUniv/lib -lxml2 -liconv  -lbz2  -lz)
    set(VDB_REQ VDB)
    set(VDB_POST_LINK install_name_tool -change @executable_path/../lib/libncbi-vdb.2.7.0.dylib @rpath/libncbi-vdb.2.dylib)
  endif ()
ENDIF ()
