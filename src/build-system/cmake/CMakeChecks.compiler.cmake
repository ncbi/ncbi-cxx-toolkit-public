...
if(OFF)
    ...
    elseif(NCBI_COMPILER_MSVC)
        if ("${NCBI_COMPILER_VERSION}" GREATER_EQUAL 1930)
            set(CMAKE_CXX_STANDARD 20)
        endif()
    endif()
endif()
...
if (WIN32)
    ...
    if (NOT NCBI_PTBCFG_FLAGS_DEFINED AND NOT NCBI_PTBCFG_PACKAGING AND NOT NCBI_PTBCFG_PACKAGED)
        if(CfgProps IN_LIST NCBI_PTBCFG_PROJECT_FEATURES)
            ...
            set(CMAKE_CXX_FLAGS_DEBUGDLL   "/MDd /Od /RTC1")
            set(CMAKE_CXX_FLAGS_DEBUGMT    "/MTd /Od /RTC1")
            set(CMAKE_CXX_FLAGS_RELEASEDLL "/MD  /O2 /Ob1")
            set(CMAKE_CXX_FLAGS_RELEASEMT  "/MT  /O2 /Ob1")

            set(CMAKE_C_FLAGS_DEBUGDLL   "/MDd /Od /RTC1")
            set(CMAKE_C_FLAGS_DEBUGMT    "/MTd /Od /RTC1")
            set(CMAKE_C_FLAGS_RELEASEDLL "/MD  /O2 /Ob1")
            set(CMAKE_C_FLAGS_RELEASEMT  "/MT  /O2 /Ob1")
            add_compile_options(/MP /Zi)
...
elseif (XCODE)
    ...
    if (NOT NCBI_PTBCFG_FLAGS_DEFINED AND NOT NCBI_PTBCFG_PACKAGING AND NOT NCBI_PTBCFG_PACKAGED)
        ...
        set(CMAKE_CXX_FLAGS_DEBUGDLL   "-g -gdwarf -ggdb3 -O0")
        set(CMAKE_CXX_FLAGS_DEBUGMT    "-g -gdwarf -ggdb3 -O0")
        set(CMAKE_CXX_FLAGS_RELEASEDLL "-Os")
        set(CMAKE_CXX_FLAGS_RELEASEMT  "-Os")

        set(CMAKE_C_FLAGS_DEBUGDLL   "-g -gdwarf -ggdb3 -O0")
        set(CMAKE_C_FLAGS_DEBUGMT    "-g -gdwarf -ggdb3 -O0")
        set(CMAKE_C_FLAGS_RELEASEDLL "-Os")
        set(CMAKE_C_FLAGS_RELEASEMT  "-Os")
