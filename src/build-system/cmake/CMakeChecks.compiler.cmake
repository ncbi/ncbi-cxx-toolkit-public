...
if (WIN32)
    ...
    if(DEFINED NCBI_PTBCFG_MAPPED_SOURCE)
        ...
        set(CMAKE_CXX_FLAGS  "${CMAKE_CXX_FLAGS} /experimental:deterministic /pathmap:${_root}=${NCBI_PTBCFG_MAPPED_SOURCE}")
        set(CMAKE_C_FLAGS    "${CMAKE_C_FLAGS} /experimental:deterministic /pathmap:${_root}=${NCBI_PTBCFG_MAPPED_SOURCE}")
    endif()
