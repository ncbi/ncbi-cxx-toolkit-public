...
ELSE()
    ...
    if ((NOT "${CMAKE_DEBUG_SYMBOLS}" STREQUAL "") AND (NOT WIN32))
        add_definitions(-gdwarf-3)
    endif()
ENDIF()
...
set(CMAKE_CXX_COMPILE_OBJECT
    "${NCBI_COMPILER_WRAPPER} <CMAKE_CXX_COMPILER> <DEFINES> <INCLUDES> <FLAGS> -o <OBJECT> -c <SOURCE>")

set(CMAKE_C_COMPILE_OBJECT
    "${NCBI_COMPILER_WRAPPER} <CMAKE_C_COMPILER> <DEFINES> <INCLUDES> <FLAGS> -o <OBJECT> -c <SOURCE>")
