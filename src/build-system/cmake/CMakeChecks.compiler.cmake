...
foreach (flag ${CMAKE_LD_FLAGS} )
  set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} -Wl,${flag}")
  set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} -Wl,${flag}")
endforeach()

#set _RDYNAMIC befor adding -wl,--no-undefined
