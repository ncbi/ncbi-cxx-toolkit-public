...
if(OFF)
    ...
    message("NCBI_PTBPROP_ALLOWED_PROJECTS: ${_allowedprojects}")
        ...
        if(BUILD_SHARED_LIBS AND (WIN32 OR XCODE))
...
function(NCBI_add_subdirectory)
    ...
    if(NCBI_PTBCFG_ENABLE_COLLECTOR AND NOT NCBI_PTB_HAS_ROOT AND NOT DEFINED NCBI_EXTERNAL_TREE_ROOT)
...
function(NCBI_internal_collect_sources)
    ...
    if (NOT NCBI_PTBMODE_PARTS)
        if (${NCBI_${NCBI_PROJECT}_TYPE} STREQUAL "SHARED" AND DEFINED NCBI_DEFAULT_DLLENTRY)
            list(APPEND _sources ${NCBI_DEFAULT_DLLENTRY})
        endif()
        if (${NCBI_${NCBI_PROJECT}_TYPE} STREQUAL "GUIAPP" AND DEFINED NCBI_DEFAULT_GUIENTRY)
            list(APPEND _sources ${NCBI_DEFAULT_GUIENTRY})
        endif()
    endif()
...
function(NCBI_internal_collect_parts)
    ...
    foreach(_part IN LISTS NCBI_${_hostproject}_PARTS)
        ...
        elseif (EXISTS ${_path}/CMakeLists.${_lib}.txt)
            ...
            message("ERROR: part ${_part} of composite project not found: ${_hostproject} (${_hostdir})")
        endif()
    endforeach()
...
function(NCBI_internal_process_project_filters _result)
    ...
    if(NOT "${NCBI_PTBCFG_PROJECT_TARGETS}" STREQUAL "")
        ...
        foreach(_prj IN LISTS NCBI_PTBCFG_PROJECT_TARGETS)
            ...
            if (_negate AND ${NCBI_PROJECT} MATCHES ${_value})
                set(${_result} FALSE PARENT_SCOPE)
                return()
            endif()
            if (NOT _negate)
...
function(NCBI_internal_add_project)
    ...
    if (NOT NCBI_PTBMODE_PARTS AND NOT NCBI_PTBMODE_COLLECT_DEPS AND NCBI_PTBCFG_ENABLE_COLLECTOR)
     ...
     if (NCBI_PTBMODE_COLLECT_DEPS AND NOT (BUILD_SHARED_LIBS AND ${NCBI_${NCBI_PROJECT}_TYPE} STREQUAL "SHARED"))
