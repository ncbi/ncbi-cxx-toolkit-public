...
# this requires that ALL subdirs use this new API
    foreach(_lib IN LISTS ARGV)
        ...
        elseif (EXISTS ${NCBI_CURRENT_SOURCE_DIR}/CMakeLists.${_lib}.asn.txt)
            ...
            message("WARNING: file not found: ${NCBI_CURRENT_SOURCE_DIR}/CMakeLists.${_lib}.lib.txt")
        endif()
    endforeach()
else()
  if(NCBI_PTBMODE_COLLECT_DEPS)
    ...
    foreach(_lib IN LISTS ARGV)
      ...
      elseif (EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/CMakeLists.${_lib}.asn.txt)
        ...
        message("WARNING: file not found: ${CMAKE_CURRENT_SOURCE_DIR}/CMakeLists.${_lib}.lib.txt")
      endif()
    endforeach()
  endif()
endif()
...
# this requires that ALL subdirs use this new API
    foreach(_app IN LISTS ARGV)
        if (EXISTS ${NCBI_CURRENT_SOURCE_DIR}/CMakeLists.${_app}.app.txt)
            ...
            message("WARNING: file not found: ${NCBI_CURRENT_SOURCE_DIR}/CMakeLists.${_app}.app.txt")
        endif()
    endforeach()
else()
  if(NCBI_PTBMODE_COLLECT_DEPS)
    ...
    foreach(_app IN LISTS ARGV)
      if (EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/CMakeLists.${_app}.app.txt)
        ...
        message("WARNING: file not found: ${CMAKE_CURRENT_SOURCE_DIR}/CMakeLists.${_app}.app.txt")
      endif()
    endforeach()
  endif()
endif()
...
function(NCBI_internal_recur_collect_dependencies _project _dep)
    ...
    if (NOT _depdeps)
        if(NOT TARGET ${_dep})
            message(WARNING "ERROR: project ${_dep} not found (${_project} requires it)")
        endif()
        return()
    endif()
...
function(NCBI_internal_print_project_info _prj)
    ...
    if(NOT "${_x}" STREQUAL "")
        ...
        foreach(_dep IN LISTS _x)
            ...
            get_property(_y GLOBAL PROPERTY NCBI_PTBPROP_DEPS_${_dep})
            if(NOT "${_y}" STREQUAL "")
                list(SORT _y)
    ...
    if(NOT "${_x}" STREQUAL "")
        message("-----------------------------------------------------------------------------")
        message("  REQUIRED COMPONENTS: ${_x}")
