...
function(NCBI_internal_collect_sources)
  ...
  if (MSVC)
    ...
    set(NCBITMP_PROJECT_SOURCES "" PARENT_SCOPE)
  endif()
endfunction()
...
message("  DEFINES = ${NCBI_${NCBI_PROJECT}_DEFINES}")
  ...
  if(NCBI_EXPERIMENTAL_CFG)
    ...
    set(NCBITMP_INCLUDES ${NCBI_${NCBI_PROJECT}_INCLUDES})
    set(NCBITMP_DEFINES ${NCBI_${NCBI_PROJECT}_DEFINES})
    set(NCBITMP_LIBS ${NCBI_${NCBI_PROJECT}_EXTLIB})
    ...
    if (NCBI_PTBMODE_COLLECT_DEPS)
      set_property(GLOBAL PROPERTY NCBI_PTBDEPS_${NCBI_PROJECT} ${NCBI_${NCBI_PROJECT}_NCBILIB})
      get_property(_deps GLOBAL PROPERTY NCBI_PTB_PROJECTS)
...
#message("${NCBI_PROJECT} test = ${_test}, cmd = ${NCBI_${_test}_CMD}, arg = ${NCBI_${_test}_ARG}")
      add_test(NAME ${_test} COMMAND ${NCBI_${_test}_CMD} ${NCBI_${_test}_ARG})
    endforeach()
  endif()
