    ...
    foreach( _type IN LISTS _known_types)
        ...
        if( ${_cnt} GREATER 0)
            ...
            if(     ${_type} STREQUAL "CONSOLEAPP")
                string(APPEND _report "console apps")
            elseif( ${_type} STREQUAL "GUIAPP")
                string(APPEND _report "GUI apps")
            elseif( ${_type} STREQUAL "STATIC")
                string(APPEND _report "static libs")
            elseif( ${_type} STREQUAL "SHARED")
                string(APPEND _report "shared libs")
            elseif( ${_type} STREQUAL "CUSTOM")
                string(APPEND _report "custom targets")
            endif()
        endif()
    endforeach()
