...
string(APPEND _summary "\nCFLAGS:        ${CMAKE_C_FLAGS} ${CMAKE_C_FLAGS_${_BuildType}} ${_CompileOptions}")
if(NOT "${NCBI_CONFIGURATION_TYPES_COUNT}" EQUAL 1)
        foreach(_cfg IN LISTS NCBI_CONFIGURATION_TYPES)
            string(TOUPPER "${_cfg}" _ucfg)
            string(APPEND _summary "\n       ${_cfg}:  ${CMAKE_C_FLAGS_${_ucfg}}")
        endforeach()
endif()
string(APPEND _summary "\nCXXFLAGS:      ${CMAKE_CXX_FLAGS} ${CMAKE_CXX_FLAGS_${_BuildType}} ${_CompileOptions}")
if(NOT "${NCBI_CONFIGURATION_TYPES_COUNT}" EQUAL 1)
        foreach(_cfg IN LISTS NCBI_CONFIGURATION_TYPES)
            string(TOUPPER "${_cfg}" _ucfg)
            string(APPEND _summary "\n       ${_cfg}:  ${CMAKE_CXX_FLAGS_${_ucfg}}")
        endforeach()
endif()
string(APPEND _summary "\nEXE_LINKER_FLAGS:    ${CMAKE_EXE_LINKER_FLAGS} ${CMAKE_EXE_LINKER_FLAGS_${_BuildType}} ${_LinkOptions}")
if(NOT "${NCBI_CONFIGURATION_TYPES_COUNT}" EQUAL 1)
        foreach(_cfg IN LISTS NCBI_CONFIGURATION_TYPES)
            string(TOUPPER "${_cfg}" _ucfg)
            string(APPEND _summary "\n       ${_cfg}:  ${CMAKE_EXE_LINKER_FLAGS_${_ucfg}}")
        endforeach()
endif()
if (BUILD_SHARED_LIBS)
    string(APPEND _summary "\nSHARED_LINKER_FLAGS:  ${CMAKE_SHARED_LINKER_FLAGS} ${CMAKE_SHARED_LINKER_FLAGS_${_BuildType}} ${_LinkOptions}")
    if(NOT "${NCBI_CONFIGURATION_TYPES_COUNT}" EQUAL 1)
            foreach(_cfg IN LISTS NCBI_CONFIGURATION_TYPES)
                string(TOUPPER "${_cfg}" _ucfg)
                string(APPEND _summary "\n       ${_cfg}:  ${CMAKE_SHARED_LINKER_FLAGS_${_ucfg}}")
            endforeach()
    endif()
endif()
if (OFF)
