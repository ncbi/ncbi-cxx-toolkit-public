...
class NCBIToolkitWithConanRecipe(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires("boost/[>=1.82.0 <=1.86.0]")
        ...
        self.requires("libpng/[>=1.6.37 <=1.6.44]")
        self.requires("libtiff/[>=4.3.0 <=4.7.0]")
        if self.settings.os == "Linux":
            self.requires("libunwind/[>=1.6.2 <=1.8.1]")
        self.requires("libuv/[>=1.45.0 <=1.46.0]")
        self.requires("libxml2/[>=2.11.4 <=2.13.4]")
...
#        self.requires("opentelemetry-cpp/1.14.2")
        ...
        self.requires("sqlite3/[>=3.40.0 <=3.46.1]")
        self.requires("zlib/[>=1.2.11 <2]")
        self.requires("zstd/[>=1.5.2 <=1.5.6]")
