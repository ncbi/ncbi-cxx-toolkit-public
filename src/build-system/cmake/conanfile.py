...
#                     can be enabled or disabled by request
    def requirements(self):
        ...
        self._default_requires("abseil/[>=20230125.3 <=20260107.1]")
        ...
        self._default_requires("boost/[>=1.82.0 <=1.91.0]")
        self._default_requires("bzip2/1.0.8")
        self._default_requires("c-ares/[>=1.19.1 <=1.34.8]")
        if self.settings.os == "Linux":
            self._default_requires("cassandra-cpp-driver/[>=2.15.3 <=2.17.1.2]")
        self._default_requires("giflib/[>=5.2.1 <=6.1.3]")
        self._default_requires("grpc/[>=1.50.1 <=1.82.0]")
        ...
        self._default_requires("libnghttp2/[>=1.51.0 <=1.68.1]")
        self._default_requires("libpng/[>=1.6.37 <=1.6.58]")
        self._default_requires("libtiff/[>=4.3.0 <=4.7.2]")
        if self.settings.os == "Linux":
            self._default_requires("libunwind/[>=1.6.2 <=1.8.3]")
        self._default_requires("libuv/[>=1.45.0 <=1.51.0]")
        self._default_requires("libxml2/[>=2.11.4 <=2.15.3]")
        self._default_requires("libxslt/[>=1.1.34 <=1.1.45]")
        ...
        self._default_requires("sqlite3/[>=3.40.0 <=3.53.4]")
        self._optional_requires("wxwidgets/3.3.2")
        self._default_requires("xz_utils/5.8.3")
        self._default_requires("zlib/[>=1.2.11 <=1.3.2]")
        self._default_requires("zstd/[>=1.5.2 <=1.5.7]")
        ...
        if self.settings.os == "Linux":
            ...
            self._internal_requires("libcurl/[>=8.8.0 <=8.21.0]")
