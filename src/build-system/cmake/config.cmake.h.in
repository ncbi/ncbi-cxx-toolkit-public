...
/* CPU type only */
#cmakedefine HOST_CPU "@HOST_CPU@"

/* System OS only */
#cmakedefine HOST_OS "@HOST_OS@"

/* System vendor only */
#cmakedefine HOST_VENDOR "@HOST_VENDOR@"

/* ======================================================================= */
/* Operating system name */
#cmakedefine NCBI_OS "@NCBI_OS@"
...
#cmakedefine NCBI_OS_CYGWIN @NCBI_OS_CYGWIN@

/* Define to 1 on Mac OS X. */
#cmakedefine NCBI_OS_DARWIN @NCBI_OS_DARWIN@

/* Define to 1 on IRIX. */
/* #undef NCBI_OS_IRIX */

/* Define to 1 on Linux. */
#cmakedefine NCBI_OS_LINUX @NCBI_OS_LINUX@

/* Define to 1 on Windows. */
#cmakedefine NCBI_OS_MSWIN @NCBI_OS_MSWIN@

/* Define to 1 on Tru64 Unix. */
/* #undef NCBI_OS_OSF1 */

/* Define to 1 on Solaris. */
#cmakedefine NCBI_OS_SOLARIS @NCBI_OS_SOLARIS@

/* Define to 1 on Unix. */
#cmakedefine NCBI_OS_UNIX @NCBI_OS_UNIX@

/* ======================================================================= */
/* Compiler name */
#cmakedefine NCBI_COMPILER "@NCBI_COMPILER@"

/* Compiler name */
#cmakedefine NCBI_COMPILER_APPLE_CLANG @NCBI_COMPILER_APPLE_CLANG@
...
/* Compiler name */
#cmakedefine NCBI_COMPILER_GCC @NCBI_COMPILER_GCC@

/* Compiler name */
#cmakedefine NCBI_COMPILER_ICC @NCBI_COMPILER_ICC@

/* Compiler name */
/* #undef NCBI_COMPILER_KCC */

/* Compiler name */
#cmakedefine NCBI_COMPILER_LLVM_CLANG @NCBI_COMPILER_LLVM_CLANG@

/* Compiler name */
/* #undef NCBI_COMPILER_MIPSPRO */

/* Compiler name */
#cmakedefine  NCBI_COMPILER_MSVC @NCBI_COMPILER_MSVC@

/* Compiler name */
#cmakedefine NCBI_COMPILER_UNKNOWN @NCBI_COMPILER_UNKNOWN@
...
#cmakedefine NCBI_COMPILER_VERSION @NCBI_COMPILER_VERSION@
...
#cmakedefine BSD_COMP 1

/* Define to 1 if you have the <Accelerate/Accelerate.h> header file. */
#cmakedefine HAVE_ACCELERATE_ACCELERATE_H 1
...
//#cmakedefine NCBI_POSIX_THREADS
...
#cmakedefine HAVE_ERROR_MESSAGE 1
...
#cmakedefine HAVE_FREEHOSTENT 1
...
/* If you have the `getservbyname_r' function, define to the number of
   arguments it takes (normally 5 or 6). */
#cmakedefine HAVE_GETSERVBYNAME_R 6
...
#cmakedefine HAVE_LAPACKE_H 1

/* Define to 1 if you have the <lapacke/lapacke.h> header file. */
#cmakedefine HAVE_LAPACKE_LAPACKE_H 1
...
#cmakedefine HAVE_MALLOC_OPTIONS 1
...
#cmakedefine HAVE_NET/INET_IN_H 1
...
#cmakedefine HAVE_STRCASECMP_LC 1
...
#cmakedefine TIME_WITH_SYS_TIME @HAVE_SYS_TIME_H@ 
...
/* Define to whatever syntax your compiler supports for declaring thread-local
   variables, or leave undefined if it doesn't. */
    //#cmakedefine NCBI_TLS_VAR @NCBI_TLS_VAR@
...
#cmakedefine HAVE_BOOST_SPIRIT 1

/* Define to 1 if the `Boost.Test' libraries are available. */
#cmakedefine HAVE_BOOST_TEST 1
...
#cmakedefine HAVE_LIBBACKWARD_CPP 1

/* Define to allow backward-cpp to also handle signals. */
#cmakedefine USE_LIBBACKWARD_SIG_HANDLING 1

/* Define to 1 if libbackward is available. */
#cmakedefine HAVE_LIBDW 1
...
#cmakedefine HAVE_SQLITE3ASYNC_H 1

/* Define to 1 if you have the `sqlite3_unlock_notify' function. */
#cmakedefine HAVE_SQLITE3_UNLOCK_NOTIFY 1
...
#cmakedefine HAVE_WXWIDGETS 1

/* Define to 1 if Xalan-C++ is available. */
#cmakedefine HAVE_XALAN 1

/* Define to 1 if Xerces-C++ is available. */
#cmakedefine HAVE_XERCES 1
...
#cmakedefine USE_LOCAL_BZLIB 1

/* Define to 1 if using a local copy of PCRE. */
#cmakedefine USE_LOCAL_PCRE 1
...
#cmakedefine HAVE_LIBGL2PS   1
#cmakedefine HAVE_LIBGRPC 1
#cmakedefine HAVE_LIBPROTOBUF 1
