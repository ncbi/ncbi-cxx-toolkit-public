...
string(TOLOWER "${NCBI_FTDS_TLS}" ncbi_ftds_tls)
if(NOT ncbi_ftds_tls MATCHES "^(|openssl|gnutls|auto|none)$")
  message(SEND_ERROR "Unsupported NCBI_FTDS_TLS setting ${NCBI_FTDS_TLS}")
endif()
if("${ncbi_ftds_tls}" STREQUAL "gnutls"
   OR ("${ncbi_ftds_tls}" STREQUAL "auto" AND NCBI_COMPONENT_OpenSSL_DISABLED))
  set(NCBI_COMPONENT_GNUTLS_DISABLED NO)
endif()
...
if(NCBI_PTBCFG_PACKAGING OR NCBI_PTBCFG_PACKAGED OR NCBI_PTBCFG_USECONAN OR NCBI_PTBCFG_HASCONAN)
    ...
    if(NCBI_PTBCFG_PACKAGED)
        NCBI_collect_NCBIpackages(ncbi-cxxtk-testboost ncbi-cxxtk-xfcgi ncbi-cxxtk-telemetry ncbi-cxxtk-hgvs ncbi-cxxtk-clog)
    endif()
endif()
...
if("${ncbi_ftds_tls}" STREQUAL "openssl")
  if(NOT NCBI_COMPONENT_OpenSSL_FOUND)
    message(SEND_ERROR "OpenSSL not found for NCBI_FTDS_TLS=${NCBI_FTDS_TLS}")
  endif()
elseif("${ncbi_ftds_tls}" STREQUAL "gnutls")
  if(NOT NCBI_COMPONENT_GNUTLS_FOUND)
    message(SEND_ERROR "GnuTLS not found for NCBI_FTDS_TLS=${NCBI_FTDS_TLS}")
  elseif(NOT NCBI_COMPONENT_GCRYPT_FOUND)
    message(SEND_ERROR "GCRYPT not found for NCBI_FTDS_TLS=${NCBI_FTDS_TLS}")
  endif()
elseif("${ncbi_ftds_tls}" STREQUAL "auto")
  if(NCBI_COMPONENT_OpenSSL_FOUND)
    set(ncbi_ftds_tls openssl)
  elseif(NCBI_COMPONENT_GnuTLS_FOUND AND NCBI_COMPONENT_GCRYPT)
    set(ncbi_ftds_tls_gnutls)
  else()
    message(WARNING "Neither OpenSSL nor GNUTLS+GCRYPT found for NCBI_FTDS_TLS=${NCBI_TDS_TLS}")
  endif()
endif()

if("${ncbi_ftds_tls}" STREQUAL "openssl")
  set(FTDS_TLS_INCLUDE ${NCBI_COMPONENT_OpenSSL_INCLUDE})
  set(FTDS_TLS_LIBS    ${NCBI_COMPONENT_OpenSSL_LIBS})
  set(NCBI_FTDS_USES_OPENSSL 1)
elseif("${ncbi_ftds_tls}" STREQUAL "gnutls")
  set(FTDS_TLS_INCLUDE
    "${NCBI_COMPONENT_GNUTLS_INCLUDE};${NCBI_COMPONENT_GCRYPT_INCLUDE}")
  set(FTDS_TLS_LIBS
    "${NCBI_COMPONENT_GNUTLS_LIBS};${NCBI_COMPONENT_GCRYPT_LIBS}")
  set(NCBI_FTDS_USES_GNUTLS 1)
endif()
...
#        NCBI_define_Xcomponent(NAME Sybase  INTERFACELIB Sybase::Sybase LIB sybblk_r64 sybct_r64 sybcs_r64 sybtcl_r64 sybcomn_r64 sybintl_r64 sybunic64)
