...
function(NCBI_internal_export_tools _file)
    ...
    string(APPEND _data "if(EXISTS \${CMAKE_CURRENT_LIST_DIR}/build-system/cmake/CMake.NCBIpkg.codegen.cmake)\n")
    string(APPEND _data "    include(\${CMAKE_CURRENT_LIST_DIR}/build-system/cmake/CMake.NCBIpkg.codegen.cmake)\n")
    string(APPEND _data "endif()\n")
