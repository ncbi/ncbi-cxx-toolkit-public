...
macro(NCBIptb_setup)
    ...
    foreach(_t IN LISTS _tmp)
        if (EXISTS ${_t}/${NCBI_DIRNAME_EXPORT}/${NCBI_PTBCFG_INSTALL_EXPORT}.cmake)
            list(APPEND NCBI_PTBCFG_PACKAGELIST ${_t}/${NCBI_DIRNAME_EXPORT})
        endif()
    endforeach()
    list(REMOVE_DUPLICATES NCBI_PTBCFG_PACKAGELIST)
    ...
    if (DEFINED NCBI_EXTERNAL_TREE_ROOT)
        ...
        if (EXISTS ${NCBI_EXTERNAL_BUILD_ROOT}/${NCBI_DIRNAME_EXPORT}/${NCBI_PTBCFG_INSTALL_EXPORT}.cmake)
            foreach(_next IN LISTS NCBI_PTBCFG_PACKAGELIST)
                if(EXISTS "${_next}/${NCBI_PTBCFG_INSTALL_EXPORT}-release.cmake")
                    include(${_next}/${NCBI_PTBCFG_INSTALL_EXPORT}.cmake)
                    set(NCBI_PTBCFG_PACKAGEIMPORTS "${_next}/${NCBI_PTBCFG_INSTALL_EXPORT}-release.cmake")
                    break()
                endif()
            endforeach()
            ...
            foreach(_next IN LISTS NCBI_PTBCFG_PACKAGELIST)
                file(GLOB _config_files "${_next}/${NCBI_PTBCFG_INSTALL_EXPORT}-*.cmake")
