...
if(NCBI_PTBCFG_ENABLE_TOOLS)
    ...
    if(DEFINED CONAN_NCBI-CXX-TOOLKIT-PUBLIC_ROOT)
        include_directories(${CONAN_NCBI-CXX-TOOLKIT-PUBLIC_ROOT}/${NCBI_DIRNAME_INCLUDE} ${NCBI_INC_ROOT})
    elseif(DEFINED CONAN_NCBI-CXX-TOOLKIT-CORE_ROOT)
        include_directories(${CONAN_NCBI-CXX-TOOLKIT-CORE_ROOT}/${NCBI_DIRNAME_INCLUDE} ${NCBI_INC_ROOT})
    endif()
