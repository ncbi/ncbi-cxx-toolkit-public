    ...
    foreach(_root IN LISTS _roots)
        foreach(_sub IN LISTS _subdirs)
            ...
            if(EXISTS ${_root}/${_libdir}/cmake)
                ...
                if(NCBI_TRACE_COMPONENT_${_name} OR NCBI_TRACE_ALLCOMPONENTS)
                    message("NCBIcomponent_find_cmake_package: find_package(${_package} ${ARGN}")
...
macro(NCBI_define_Xcomponent)
    cmake_parse_arguments(DC "" "NAME;PACKAGE;MODULE;LIBPATH_SUFFIX;INCPATH_SUFFIX" "LIB;INCLUDE;ADD_COMPONENT;CHECK_INCLUDE;CMAKE_PACKAGE" ${ARGN})
