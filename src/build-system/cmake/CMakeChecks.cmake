...
if (NCBI_EXPERIMENTAL_CFG)
    ...
    if (WIN32 OR XCODE)
        ...
        endforeach()
message("NCBI_BUILD_ROOT is ${NCBI_BUILD_ROOT}")
message("NCBI_DIRNAME_BUILD is ${NCBI_DIRNAME_BUILD}")
message("if(NOT EXISTS ${NCBI_BUILD_ROOT}/${NCBI_DIRNAME_BUILD}/corelib/ncbicfg.c)")
        if(NOT EXISTS ${NCBI_BUILD_ROOT}/${NCBI_DIRNAME_BUILD}/corelib/ncbicfg.c)
message("file(WRITE ${NCBI_BUILD_ROOT}/${NCBI_DIRNAME_BUILD}/corelib/ncbicfg.c \"#include <common/config/ncbicfg.cfg.c>\")")
