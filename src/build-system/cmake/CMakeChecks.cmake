...
set(GCRYPT_INCLUDE  ${NCBI_TOOLS_ROOT}/libgcrypt-1.4.3/include ${NCBI_TOOLS_ROOT}/libgpg-error-1.6/include)
...
set(TLS_INCLUDE     ${NCBI_TOOLS_ROOT}/libgcrypt-1.4.3/include ${NCBI_TOOLS_ROOT}/libgpg-error-1.6/include ${NCBI_TOOLS_ROOT}/gnutls-2.4.2/include)
...
#
# BerkeleyDB
set(BERKELEYDB_INCLUDE ${NCBI_TOOLS_ROOT}/BerkeleyDB/include)
...
set(PYTHON_INCLUDE  /opt/python-2.5.1/include/python2.5 /opt/python-2.5.1/include/python2.5)
...
set(PYTHON24_LIBS)
set(PYTHON25_INCLUDE  /opt/python-2.5.1/include/python2.5 /opt/python-2.5.1/include/python2.5)
...
set(LIBXML_INCLUDE     ${NCBI_TOOLS_ROOT}/libxml-2.7.8/${buildconf}/include/libxml2 ${NCBI_TOOLS_ROOT}/libxml-2.7.8/${buildconf}/include)
...
set(LIBXSLT_INCLUDE    ${NCBI_TOOLS_ROOT}/libxml-2.7.8/${buildconf}/include/libxml2 ${NCBI_TOOLS_ROOT}/libxml-2.7.8/${buildconf}/include ${NCBI_TOOLS_ROOT}/libxml-2.7.8/${buildconf}/include)
...
set(LIBEXSLT_INCLUDE   ${NCBI_TOOLS_ROOT}/libxml-2.7.8/${buildconf}/include/libxml2 ${NCBI_TOOLS_ROOT}/libxml-2.7.8/${buildconf}/include ${NCBI_TOOLS_ROOT}/libxml-2.7.8/${buildconf}/include ${NCBI_TOOLS_ROOT}/libxml-2.7.8/${buildconf}/include)
...
set(FTGL_INCLUDE     /usr/include/freetype2 ${NCBI_TOOLS_ROOT}/ftgl-2.1.3-rc5/include)
...
# MongoDB
set(MONGODB_INCLUDE     ${NCBI_TOOLS_ROOT}/boost-1.53.0-ncbi1/include/boost-1_53 -Wno-unused-local-typedefs ${NCBI_TOOLS_ROOT}/mongodb-2.4.6/include)
...
set(SRA_INCLUDE ${includedir}/../src/sra/sdk/interfaces
              ${top_srcdir}/src/sra/sdk/interfaces)
...
set(SRA_INTERNAL_CPPFLAGS -D_GNU_SOURCE ${D_SFX}
    -DLIBPREFIX=lib -DSHLIBEXT=${DLL}${dll_ext} ${NO_STRICT_ALIASING})
