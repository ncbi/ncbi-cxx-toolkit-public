...
if(OFF)
        ...
        if (WIN32)
            if (BUILD_SHARED_LIBS)
                set(NCBI_SIGNATURE_CFG "${NCBI_COMPILER_ALT}-\$<CONFIG>MTdll64--${HOST_CPU}-win64-${_local_host_name}")
            else()
                set(NCBI_SIGNATURE_CFG "${NCBI_COMPILER_ALT}-\$<CONFIG>MTstatic64--${HOST_CPU}-win64-${_local_host_name}")
            endif()
        endif()
    else()
#Linux
