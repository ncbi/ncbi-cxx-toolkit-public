...
if (NCBI_EXPERIMENTAL_CFG)
    ...
    if (WIN32 OR XCODE)
        foreach(_cfg ${CMAKE_CONFIGURATION_TYPES})
            ...
            configure_file(${includedir}/common/ncbi_build_ver.h.in ${NCBI_CFGINC_ROOT}/${_cfg}/common/ncbi_build_ver.h)
        endforeach()
...
#Linux
        ...
        configure_file(${includedir}/common/ncbi_build_ver.h.in ${NCBI_CFGINC_ROOT}/common/ncbi_build_ver.h)
    endif()
