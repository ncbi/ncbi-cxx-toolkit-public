...
if (NOT "$ENV{TEAMCITY_VERSION}" STREQUAL "")
    ...
    if(NOT "${TEAMCITY_BUILD_PROPERTIES_FILE}" STREQUAL "" AND EXISTS "${TEAMCITY_BUILD_PROPERTIES_FILE}")
        file(STRINGS "${TEAMCITY_BUILD_PROPERTIES_FILE}" _list)
    ...
    if ("${NCBI_TEAMCITY_BUILD_ID}" STREQUAL "")
        string(UUID NCBI_TEAMCITY_BUILD_ID NAMESPACE "73203eb4-80d3-4957-a110-8aae92c7e615" NAME "www.ncbi.nlm.nih.gov" TYPE SHA1)
    endif()
    message(STATUS "TeamCity build number = ${NCBI_TEAMCITY_BUILD_NUMBER}")
