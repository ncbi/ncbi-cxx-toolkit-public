...
/** @file
 * This file helps to suppress auto_ptr related warnings
 * The approach is mostly copied from the NCBI C++ Toolkit code.
**/


#ifndef _allow_auto_ptr_hpp_
#define _allow_auto_ptr_hpp_
