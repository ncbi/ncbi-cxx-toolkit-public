...
LIB = xdiscrepancy xcleanup xunittestutil xobjutil $(OBJEDIT_LIBS) taxon3 valid test_boost macro $(SEQ_LIBS) $(OBJMGR_LIBS) $(OBJREAD_LIBS) $(CMPRS_LIB) xregexp $(PCRE_LIB) xncbi
