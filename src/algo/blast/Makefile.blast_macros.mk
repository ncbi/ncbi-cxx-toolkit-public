...
BLAST_FORMATTER_MINIMAL_LIBS = xblastformat align_format taxon1 blastdb_format \
     $(XFORMAT_LIBS) xalnmgr blastxml blastxml2 xcgi xhtml
...
BLAST_THIRD_PARTY_INCLUDE       = $(IPS4O_INCLUDE) $(TBB_INCLUDE) $(LMDB_INCLUDE) $(SQLITE3_INCLUDE)
BLAST_THIRD_PARTY_LIBS          = $(IPS4O_LIBS) $(TBB_LIBS) $(ATOMIC_LIBS) $(SQLITE3_LIBS) $(LMDB_LIBS)
BLAST_THIRD_PARTY_STATIC_LIBS   = $(TBB_STATIC_LIBS) $(ATOMIC_LIBS) $(SQLITE3_STATIC_LIBS) $(LMDB_STATIC_LIBS)
