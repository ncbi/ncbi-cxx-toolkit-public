...
public:
    ...
    BOOST_AUTO_TEST_CASE(FilterOptionsFromNULLString)
    {
        ...
        BOOST_REQUIRE_EQUAL(false, (bool) filtering_options->mask_at_hash);
    ...
    BOOST_AUTO_TEST_CASE(FilterOptionsFromStringDustMaskAtHash)
    {
        ...
        BOOST_REQUIRE(status == 0);
        BOOST_REQUIRE_EQUAL(true, (bool) filtering_options->mask_at_hash);
    ...
    BOOST_AUTO_TEST_CASE(FilterMerge)
    {
          ...
          BOOST_REQUIRE_EQUAL(true, (bool) result->mask_at_hash);
