#ifndef ALGO_BLAST_GUMBEL_PARAMS__INCLUDED_NJN_IOUTIL
#define ALGO_BLAST_GUMBEL_PARAMS__INCLUDED_NJN_IOUTIL
...
#endif //! ALGO_BLAST_GUMBEL_PARAMS__INCLUDED_NJN_IOUTIL
