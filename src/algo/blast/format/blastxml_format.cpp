                       ...
                       CNcbiOstream *out_stream)
{
    ...
    while (iter != alnset.Get().end()) {
		...
		unique_ptr<CObjectOStreamXml> xml_one_hit_os (new CObjectOStreamXml (one_hit_os,eNoOwnership));
		...
		bool add_xml_version )
{
    ...
    {
	unique_ptr<CObjectOStreamXml> xml_one_iter_os(new CObjectOStreamXml (one_iter_ss_os,eNoOwnership));
