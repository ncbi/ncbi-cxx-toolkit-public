...
double CGnomonEngine::Run(bool leftwall, bool rightwall, double mpp)
{
    TGeneModelList cls;
                          ...
                          const CGnomonAnnotator_Base::TIntMap& notbridgeable_gaps_len, const CGnomonAnnotator_Base::TGgapInfo& ggapinfo)
{
    ...
    m_data->m_ss->Init(m_data->m_seq, leftwall, rightwall, consensuspenalty, notbridgeable_gaps_len, ggapinfo);
