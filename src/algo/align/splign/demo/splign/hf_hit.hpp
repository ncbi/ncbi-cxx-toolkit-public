#ifndef ALGO_DEMO_SPLIGN_HF_HIT__HPP
#define ALGO_DEMO_SPLIGN_HF_HIT__HPP
...
public:
    ...
    int	m_ai [4];                  // normalized data
    double m_Value;               // expected value
    double m_Score;               // bit score

    int m_GroupID;                // id of the group the hit belongs to
    int m_MaxDistClustID;         // id of Max Dist group
