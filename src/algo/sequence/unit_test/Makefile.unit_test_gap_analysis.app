...
# "make check".
CHECK_CMD = unit_test_gap_analysis -basic-data gap_analysis.seq.asn -in-letter-gap-data gap_with_letters.seq.asn -mixed-gap-type-data mixed_gap_type_data.seq.asn /CHECK_NAME=unit_test_gap_analysis
