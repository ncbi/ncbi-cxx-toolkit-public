...
LIB = xalgoseq xalnmgr xobjread xvalidate valerr submit valid taxon3 xalnmgr xformat gbseq xobjutil taxon1 xregexp tables test_boost $(OBJMGR_LIBS) $(PCRE_LIB) 
