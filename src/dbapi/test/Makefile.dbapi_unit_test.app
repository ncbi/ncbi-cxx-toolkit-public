...
LIB  = ncbi_xdbapi_ftds ncbi_xdbapi_ftds100 $(FTDS100_LIB) \
       ncbi_xdbapi_ftds14 $(FTDS14_LIB) $(DBAPI_CTLIB) $(DBAPI_ODBC) \
...
LIBS = $(SYBASE_LIBS) $(SYBASE_DLLS) $(ODBC_LIBS) $(FTDS100_LIBS) \
       $(FTDS14_LIBS) $(CMPRS_LIBS) $(NETWORK_LIBS) $(ORIG_LIBS)
...
CHECK_CMD = dbapi_unit_test -dr ftds14     -S MsSql
CHECK_CMD = dbapi_unit_test -dr ftds14     -S MsSql -V 74
CHECK_CMD = dbapi_unit_test -dr odbc       -S MsSql
CHECK_CMD = dbapi_unit_test -dr odbc       -S MsSql -V 74
CHECK_CMD = dbapi_unit_test -dr ftds100    -S DBAPI_MS2025_TEST
CHECK_CMD = dbapi_unit_test -dr ftds100    -S DBAPI_MS2025_TEST -V 74
CHECK_CMD = dbapi_unit_test -dr ftds14     -S DBAPI_MS2025_TEST
CHECK_CMD = dbapi_unit_test -dr ftds14     -S DBAPI_MS2025_TEST -V 74
CHECK_CMD = dbapi_unit_test -dr odbc       -S DBAPI_MS2025_TEST
CHECK_CMD = dbapi_unit_test -dr odbc       -S DBAPI_MS2025_TEST -V 74
CHECK_CMD = dbapi_unit_test -dr ctlib      -S Sybase
CHECK_CMD = dbapi_unit_test -dr ftds100    -S Sybase
CHECK_CMD = dbapi_unit_test -dr ftds14     -S Sybase
CHECK_CMD = dbapi_unit_test -dr ctlib      -S DBAPI_DEV16_16K
CHECK_CMD = dbapi_unit_test -dr ftds100    -S DBAPI_DEV16_16K
CHECK_CMD = dbapi_unit_test -dr ftds14     -S DBAPI_DEV16_16K
...
CHECK_CMD = dbapi_unit_test -dr ftds14     -S DBAPI_MS2022_TEST_LB -conffile namerd.ini
