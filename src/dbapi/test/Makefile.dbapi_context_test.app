...
LIB  = ncbi_xdbapi_ftds ncbi_xdbapi_ftds100 $(FTDS100_LIB) \
       ncbi_xdbapi_ftds14 $(FTDS14_LIB) $(DBAPI_CTLIB) \
...
CHECK_CMD = dbapi_context_test -dr ftds14     -S MsSql
CHECK_CMD = dbapi_context_test -dr ftds14     -S MsSql -V 74
