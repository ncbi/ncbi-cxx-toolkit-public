...
const char* ftds95_driver = "ftds95";
...
NCBITEST_INIT_VARIABLES(parser)
{
    ...
    parser->AddSymbol("DRIVER_ftds95", GetArgs().GetDriverName() == ftds95_driver);
...
#define FTDS_DRIVERS ftds_driver, ftds64_driver, ftds95_driver, ftds100_driver
