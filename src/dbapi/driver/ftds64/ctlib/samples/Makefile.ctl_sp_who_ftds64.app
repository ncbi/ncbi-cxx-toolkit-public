...
LIB  = ncbi_xdbapi_ftds64$(STATIC) $(FTDS64_CTLIB_LIB) dbapi_driver$(STATIC) \
       $(XCONNEXT) xconnect xncbi
...
CHECK_CMD = run_sybase_app.sh ctl_sp_who_ftds64 -S MS2008DEV1 /CHECK_NAME=ctl_sp_who_ftds64-MS2008
