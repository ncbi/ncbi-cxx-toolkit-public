...
CDB_Object* CTDS_BlobResult::GetItem(CDB_Object* item_buff)
{
    ...
    case 0:
        ...
        break;
    default:
        throw CDB_ClientEx(eDB_Error, 280003, "CTDS_BlobResult::GetItem",
                           "dbreadtext failed");
    }
                                 ...
                                 bool* is_null)
{
    ...
    case 0:
        ...
        break;
    case -1:
        throw CDB_ClientEx(eDB_Error, 280003, "CTDS_BlobResult::ReadItem",
                           "dbreadtext failed");
    default:
        break;
    }
...
I_ITDescriptor* CTDS_BlobResult::GetImageOrTextDescriptor()
{
    ...
    if (s == -1) {
        throw CDB_ClientEx(eDB_Error, 280003,
                           "CTDS_BlobResult::GetImageOrTextDescriptor",
                           "dbreadtext failed");
    }
...
bool CTDS_BlobResult::SkipItem()
{
    ...
    case 0:
        ...
        break;
    default:
        throw CDB_ClientEx(eDB_Error, 280003, "CTDS_BlobResult::SkipItem",
                           "dbreadtext failed");
    }
    return true;
}
...
CDB_Object* CTDS_StatusResult::GetItem(CDB_Object* item_buff)
{
    ...
    if (item_buff->GetType() != eDB_Int) {
        throw CDB_ClientEx(eDB_Error, 230020, "CTDS_StatusResult::GetItem",
                           "wrong type of CDB_Object");
    }
