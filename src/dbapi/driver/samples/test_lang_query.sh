...
if echo $FEATURES | grep "\-connext" > /dev/null ; then
    server_list="DBAPI_MS2022_TEST DBAPI_MS2025_TEST DBAPI_DEV16_2K"
    server_list="$server_list DBAPI_DEV16_16K"
else
    # server_list="MSDEV2"
    server_list="DBAPI_MS2022_TEST_LB DBAPI_MS2025_TEST_LB DBAPI_DEV16_2K"
    server_list="$server_list DBAPI_DEV16_16K"
fi
