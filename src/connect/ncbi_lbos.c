...
{ 
    ...
    char* servicename_url_encoded;
    size_t url_length;
    char * url;
    char * lbos_answer; /*to write down lbos's answer*/
    const char* user_dtab; 
    size_t length;
                             ...
                             char**                  lbos_answer)
{
    ...
    parsed_symbols = sscanf(buf, "{\"watcher\":\"%[^\"]\"}", lbos_addr);
    if (parsed_symbols != 1) {
