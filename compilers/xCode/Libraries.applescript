...
property gbench_cache_agent : {name:"gbench_cache_agent", path:"app:netcache", inc:{"netcached.cpp", "smng_thread.cpp", "nc_request_parser.cpp", "process_ic.cpp"}, dep:"ncbi_core ncbi_bdb ncbi_xcache_bdb ncbi_xcache_netcache db", req:true}
(* ====================================================================================================== *)
