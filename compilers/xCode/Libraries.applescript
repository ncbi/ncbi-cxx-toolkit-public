...
-- Core
property xncbi : {name:"xncbi", path:"corelib", exc:{"test_mt.cpp", "ncbi_os_mac.cpp", "ncbi_os_mswin.cpp", "ncbicfg.c.in", "ncbi_stack_default.cpp", "ncbi_stack_linux.cpp", "ncbi_stack_solaris.cpp", "ncbi_stack_win32.cpp"}}
 ...
 *
 * Revision 1.106  2006/08/01 17:18:56  lebedev
 * gui_widgets_aln += ncbi_algo
 *
 ...
 *
 * Revision 1.102  2006/05/04 18:00:38  lebedev
 * Add hpp files to the resulting project, so the Xcode CodeSense will work
 *
 * Revision 1.101  2006/04/28 13:37:34  lebedev
 * gui_services += gui_widgets_seq
 *
 * Revision 1.100  2006/04/14 13:07:54  lebedev
 * dload_basic += gui_services
 *
 ...
 *
 * Revision 1.90  2006/02/21 14:03:07  lebedev
 * Lib gui_services added
 *
