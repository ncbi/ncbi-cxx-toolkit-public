...
--property gbench_svc_cli : {name:"gbench_svc", path:"gui:core", inc:{"gbench_svc__.cpp", "gbench_svc___.cpp"}, asn1:true, asn1Name:"gbench_svc"}
...
property ncbi_xreader_cache : {name:"ncbi_xreader_cache", libs:{xreader_cache}, dep:"ncbi_core ncbi_xreader ncbi_pub ncbi_seq ncbi_seqext", req:true}
...
property ncbi_xloader_cdd : {name:"ncbi_xloader_cdd", libs:{xloader_cdd}, dep:"ncbi_core ncbi_pub ncbi_seq ncbi_seqext ncbi_xreader ncbi_xreader_id1 ncbi_xreader_id2 ncbi_xreader_pubseqos ncbi_xreader_cache ncbi_general", req:true}
...
property gui_core : {name:"gui_core", libs:{gui__core, xgbplugin, gui_project, data_handle}, dep:"gui_config gui_dialogs gui_utils gui_widgets ncbi_core ncbi_web ncbi_general ncbi_seq ncbi_seqext ncbi_misc" & FLTK_LIBS, req:true}
...
property view_text : {name:"view_text", libs:{gui_view_text}, exc:{"view_seq_text.cpp"}, dep:"ncbi_core ncbi_pub ncbi_seq ncbi_seqext ncbi_general gui_core gui_utils gui_widgets gui_widgets_seq gui_dialogs" & FLTK_LIBS, bundle:true, req:true}
 ...
 * ===========================================================================
 * $Log$
 * Revision 1.81  2005/11/18 16:48:02  lebedev
 * temporary disable seq_text
 *
 * Revision 1.80  2005/11/18 16:02:32  lebedev
 ...
 *
 * Revision 1.70  2005/09/21 18:29:52  lebedev
 * ncbi_algo += contig_assembly
 *
 ...
 * algo += dustmask
 *
 * Revision 1.63  2005/07/19 18:26:21  lebedev
 * Libraries updated
 *
 * Revision 1.62  2005/07/13 14:00:44  lebedev
 * libgui_core updated
 *
 * Revision 1.61  2005/07/12 18:10:42  lebedev
 * Dependencies updated for dload_basic
 *
 ...
 *
 * Revision 1.56  2005/05/26 12:45:09  lebedev
 * gui_core += ncbi_web
 *
