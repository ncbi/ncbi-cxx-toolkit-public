@ECHO OFF
REM $Id: all_ncbi.bat,v 1.1 2004/02/26 14:41:16 ivanov Exp $
REM ===========================================================================
REM 
...
:CONFIG
devenv ncbi_cpp.sln /rebuild ReleaseDLL /project "-CONFIGURE-"
...
devenv ncbi_cpp.sln /rebuild %CFG% /project "-HIERARCHICAL-VIEW-"
IF ERRORLEVEL 1 GOTO ABORT
