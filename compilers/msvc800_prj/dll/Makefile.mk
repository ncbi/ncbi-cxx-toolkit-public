...
install_fltk :
	...
	@copy /Y $(FLTK_BINPATH)\$(INTDIR)\*.dll $(INSTALL_BINPATH) > NUL
	@copy /Y $(FLTK_BINPATH)\$(INTDIR)\*.pdb $(INSTALL_BINPATH) > NUL

install_berkeleydb :
	@echo Coping BerkeleyDB DLLs...
	@copy /Y $(BERKELEYDB_BINPATH)\$(INTDIR)\*.dll $(INSTALL_BINPATH) > NUL
	@copy /Y $(BERKELEYDB_BINPATH)\$(INTDIR)\*.pdb $(INSTALL_BINPATH) > NUL

install_sqlite :
	@echo Coping SQLITE DLLs...
	@copy /Y $(SQLITE_BINPATH)\$(INTDIR)\*.dll $(INSTALL_BINPATH) > NUL
