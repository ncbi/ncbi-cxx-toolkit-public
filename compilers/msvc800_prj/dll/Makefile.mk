...
install_fltk:
	...
	$(TEST_NOT_STAMP)\fltk.installed       copy /Y $(FLTK_SRC)\*.dll $(INSTALL_BINPATH) > NUL
	$(TEST_NOT_STAMP)\fltk.installed       if exist "$(FLTK_SRC)\*.pdb" copy /Y $(FLTK_SRC)\*.pdb $(INSTALL_BINPATH) > NUL
...
install_berkeleydb:
	...
	$(TEST_NOT_STAMP)\berkeleydb.installed copy /Y $(BERKELEYDB_SRC)\*.dll $(INSTALL_BINPATH) > NUL
	$(TEST_NOT_STAMP)\berkeleydb.installed if exist "$(BERKELEYDB_SRC)\*.pdb" copy /Y $(BERKELEYDB_SRC)\*.pdb $(INSTALL_BINPATH) > NUL
...
install_sqlite:
	...
	$(TEST_NOT_STAMP)\sqlite.installed     copy /Y $(SQLITE_SRC)\*.dll $(INSTALL_BINPATH) > NUL
	$(TEST_NOT_STAMP)\sqlite.installed     if exist "$(SQLITE_SRC)\*.pdb" copy /Y $(SQLITE_SRC)\*.pdb $(INSTALL_BINPATH) > NUL
...
install_wxwindows:
	...
	$(TEST_NOT_STAMP)\wxwindows.installed  copy /Y $(WXWINDOWS_SRC)\*.dll $(INSTALL_BINPATH) > NUL
	$(TEST_NOT_STAMP)\wxwindows.installed  if exist "$(WXWINDOWS_SRC)\*.pdb" copy /Y $(WXWINDOWS_SRC)\*.pdb $(INSTALL_BINPATH) > NUL
...
install_sybase:
	...
	$(TEST_NOT_STAMP)\sybase.installed     copy /Y $(SYBASE_SRC)\*.dll $(INSTALL_BINPATH) > NUL
	$(TEST_NOT_STAMP)\sybase.installed     if exist "$(SYBASE_SRC)\*.pdb" copy /Y $(SYBASE_SRC)\*.pdb $(INSTALL_BINPATH) > NUL
...
install_mysql:
	...
	$(TEST_NOT_STAMP)\mysql.installed      copy /Y $(MYSQL_SRC)\*.dll $(INSTALL_BINPATH) > NUL
	$(TEST_NOT_STAMP)\mysql.installed      if exist "$(MYSQL_SRC)\*.pdb" copy /Y $(MYSQL_SRC)\*.pdb $(INSTALL_BINPATH) > NUL
...
install_mssql:
	...
	$(TEST_NOT_STAMP)\mssql.installed      copy /Y $(MSSQL_SRC)\*.dll $(INSTALL_BINPATH) > NUL
	$(TEST_NOT_STAMP)\mssql.installed      if exist "$(MSSQL_SRC)\*.pdb" copy /Y $(MSSQL_SRC)\*.pdb $(INSTALL_BINPATH) > NUL
...
install_msvc:
	...
	$(TEST_NOT_STAMP)\msvc.installed       copy /Y $(MSVCRT_SRC)\*.dll $(INSTALL_BINPATH) > NUL
	$(TEST_NOT_STAMP)\msvc.installed       if exist "$(MSVCRT_SRC)\*.pdb" copy /Y $(MSVCRT_SRC)\*.pdb $(INSTALL_BINPATH) > NUL
