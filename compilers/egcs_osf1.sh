...
NCBI_C_INCLUDE=${NCBI_C_INCLUDE:="$HOME/ncbi/include"}
NCBI_C_RELEASE_LIB=${NCBI_C_RELEASE_LIB:="$HOME/ncbi/lib"}
NCBI_C_DEBUG_LIB=${NCBI_C_DEBUG_LIB:="$HOME/ncbi/altlib"}
