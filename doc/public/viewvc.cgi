...
path_map = (
    ('include/gui', 'gbench/branches/c++-toolkit-2.7.1/include/gui'),
    ('src/gui',     'gbench/branches/c++-toolkit-2.7.1/src/gui'),
    ('src/sra/sdk', 'misc_projects/production/components/sra_sdk/2.3.2')
    )
